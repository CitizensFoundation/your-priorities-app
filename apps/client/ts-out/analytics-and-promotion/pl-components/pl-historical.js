...
let PlausibleHistorical = class PlausibleHistorical extends PlausibleBaseElementWithState {
    constructor() {
        super(...arguments);
        this.stuck = false;
    }
...
], PlausibleHistorical.prototype, "history", void 0);
__decorate([
    property({ type: Boolean })
], PlausibleHistorical.prototype, "stuck", void 0);
__decorate([
    property({ type: Array })
], PlausibleHistorical.prototype, "highlightedGoals", void 0);
PlausibleHistorical = __decorate([
    customElement('pl-historical')
], PlausibleHistorical);
export { PlausibleHistorical };
//# sourceMappingURL=pl-historical.js.map