...
let PlausibleSourcesUtm = class PlausibleSourcesUtm extends PlausibleSourcesBase {
    constructor() {
        super(...arguments);
        this.to = undefined;
    }
    connectedCallback() {
        ...
        if (this.timer)
            this.timer.onTick(this.fetchReferrers.bind(this));
    }
    fetchReferrers() {
        ...
        api
            .get(this.proxyUrl, `/api/stats/${encodeURIComponent(this.site.domain)}/${endpoint}`, this.query, { show_noref: this.showNoRef })
            .then(res => {
            this.loading = false;
            this.referrers = res;
        });
...
], PlausibleSourcesUtm.prototype, "to", void 0);
PlausibleSourcesUtm = __decorate([
    customElement('pl-sources-utm')
], PlausibleSourcesUtm);
export { PlausibleSourcesUtm };
//# sourceMappingURL=pl-sources-utm.js.map