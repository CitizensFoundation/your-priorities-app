...
import { METRIC_FORMATTER, METRIC_LABELS, } from './pl-visitors-graph.js';
import { PlausibleBaseElementWithState } from '../../pl-base-element-with-state.js';
let PlausibleLineGraph = class PlausibleLineGraph extends PlausibleBaseElementWithState {
    constructor() {
        super();
    ...
    regenerateChart() {
        let graphEl = this.$$('canvas');
        if (!graphEl) {
            graphEl = this.canvasElement;
        }
        this.ctx = graphEl.getContext('2d');
        const dataSet = buildDataSet(this.graphData.plot, this.graphData.present_index, this.ctx, METRIC_LABELS[this.metric], false);
...
], PlausibleLineGraph.prototype, "graphData", void 0);
__decorate([
    property({ type: String })
], PlausibleLineGraph.prototype, "metric", void 0);
__decorate([
    property({ type: Object })
], PlausibleLineGraph.prototype, "ctx", void 0);
__decorate([
    property({ type: Boolean })
], PlausibleLineGraph.prototype, "darkTheme", void 0);
__decorate([
    property({ type: Object })
], PlausibleLineGraph.prototype, "chart", void 0);
__decorate([
    property({ type: Object })
], PlausibleLineGraph.prototype, "updateMetric", void 0);
__decorate([
    property({ type: Object })
], PlausibleLineGraph.prototype, "history", void 0);
__decorate([
    property({ type: Object })
], PlausibleLineGraph.prototype, "topStatData", void 0);
__decorate([
    query('canvas')
], PlausibleLineGraph.prototype, "canvasElement", void 0);
__decorate([
    property({ type: Boolean })
], PlausibleLineGraph.prototype, "exported", void 0);
PlausibleLineGraph = __decorate([
    customElement('pl-line-graph')
], PlausibleLineGraph);
export { PlausibleLineGraph };
//# sourceMappingURL=pl-line-graph.js.map