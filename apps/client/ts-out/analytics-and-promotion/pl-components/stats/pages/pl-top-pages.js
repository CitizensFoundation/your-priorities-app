...
let PlausableTopPages = class PlausableTopPages extends PlausableBasePages {
    constructor() {
        super();
        this.pagePath = '/pages';
    }
...
PlausableTopPages = __decorate([
    customElement('pl-top-pages')
], PlausableTopPages);
export { PlausableTopPages };
//# sourceMappingURL=pl-top-pages.js.map