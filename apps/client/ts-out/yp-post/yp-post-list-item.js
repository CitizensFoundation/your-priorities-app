...
let YpPostListItem = class YpPostListItem extends YpPostBaseWithAnswers(YpBaseElement) {
    constructor() {
        super(...arguments);
        this.elevation = 1;
        this.mini = false;
          ...
          >
            ...
            ? html `
                      <div class="description tagContainer wrap">
                        ${this.postTags.map((index, item) => html `
  ...
  */
    ...
    _openReport() {
        ...
        window.appDialogs
            .getDialogAsync('apiActionDialog', (dialog) => {
...
], YpPostListItem.prototype, "elevation", void 0);
__decorate([
...
__decorate([
    property({ type: Boolean })
], YpPostListItem.prototype, "isEndorsed", void 0);
