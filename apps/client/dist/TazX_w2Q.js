import{d as t,_ as a,n as i,f as e,s as o,x as r,e as n,T as s,i as l,t as c,g as d,h as v,j as m,N as b,o as p,L as g}from"./C7qipqwV.js";
/**
 * @license
 ...
 */class h extends o{constructor(){super(...arguments),this.disabled=!1,this.active=!1,this.hideInactiveLabel=!1,this.badgeValue="",this.showBadge=!1}render(){const{ariaLabel:t}=this;return r` <button
      ...
      >${this.renderLabel()}
          ...
          >${this.label}</span
        >`:s}firstUpdated(t){super.firstUpdated(t);const a=new Event("navigation-tab-rendered",{bubbles:!0,composed:!0});this.dispatchEvent(a)}focus(){const t=this.buttonElement;t&&t.focus()}blur(){const t=this.buttonElement;t&&t.blur()}handleClick(){this.dispatchEvent(new CustomEvent("navigation-tab-interaction",{detail:{state:this},bubbles:!0,composed:!0}))}}t(h),a([i({type:Boolean})],h.prototype,"disabled",void 0),a([i({type:Boolean,reflect:!0})],h.prototype,"active",void 0),a([i({type:Boolean,attribute:"hide-inactive-label"})],h.prototype,"hideInactiveLabel",void 0),a([i()],h.prototype,"label",void 0),a([i({attribute:"badge-value"})],h.prototype,"badgeValue",void 0),a([i({type:Boolean,attribute:"show-badge"})],h.prototype,"showBadge",void 0),a([e("button")],h.prototype,"buttonElement",void 0);
/**
  * @license
  * Copyright 2022 Google LLC
  * SPDX-License-Identifier: Apache-2.0
 ...
 * SPDX-License-Identifier: Apache-2.0
 */;let u=class extends h{};u.styles=[y],u=a([c("md-navigation-tab")],u);
/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
class f extends o{constructor(){super(...arguments),this.disabled=!1,this.type="text",this.isListItem=!0,this.href="",this.target=""}get isDisabled(){return this.disabled&&"link"!==this.type}willUpdate(t){this.href&&(this.type="link"),super.willUpdate(t)}render(){return this.renderListItem(r`
    ...
    `)}renderListItem(t){const a="link"===this.type;let i;switch(this.type){case"link":i=d`a`;break;case"button":i=d`button`;break;default:i=d`li`}const e="text"!==this.type,o=a&&this.target?this.target:s;return v`
      <${i}
        id="item"
    ...
    `}onFocus(){-1===this.tabIndex&&this.dispatchEvent(m())}focus(){this.listItemRoot?.focus()}}t(f),f.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0},a([i({type:Boolean,reflect:!0})],f.prototype,"disabled",void 0),a([i({reflect:!0})],f.prototype,"type",void 0),a([i({type:Boolean,attribute:"md-list-item",reflect:!0})],f.prototype,"isListItem",void 0),a([i()],f.prototype,"href",void 0),a([i()],f.prototype,"target",void 0),a([e(".list-item")],f.prototype,"listItemRoot",void 0);
/**
  * @license
  * Copyright 2022 Google LLC
  * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let x=class extends f{};x.styles=[_],x=a([c("md-list-item")],x);
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
const w=new Set(Object.values(b));class z extends o{get items(){return this.listController.items}constructor(){super(),this.listController=new g({isItem:t=>t.hasAttribute("md-list-item"),getPossibleItems:()=>this.slotItems,isRtl:()=>"rtl"===getComputedStyle(this).direction,deactivateItem:t=>{t.tabIndex=-1},activateItem:t=>{t.tabIndex=0},isNavigableKey:t=>w.has(t),isActivatable:t=>!t.disabled&&"text"!==t.type}),this.internals=this.attachInternals(),this.internals.role="list",this.addEventListener("keydown",this.listController.handleKeydown)}render(){return r`
    ...
    `}activateNextItem(){return this.listController.activateNextItem()}activatePreviousItem(){return this.listController.activatePreviousItem()}}a([p({flatten:!0})],z.prototype,"slotItems",void 0);
/**
  * @license
  * Copyright 2022 Google LLC
  * SPDX-License-Identifier: Apache-2.0
  */
const $=l`:host{background:var(--md-list-container-color, var(--md-sys-color-surface, #fef7ff));color:unset;display:flex;flex-direction:column;outline:none;padding:8px 0;position:relative}/*# sourceMappingURL=list-styles.css.map */
`
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let k=class extends z{};k.styles=[$],k=a([c("md-list")],k);
