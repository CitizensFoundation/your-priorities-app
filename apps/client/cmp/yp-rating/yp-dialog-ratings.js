...
let YpDialogRatings = class YpDialogRatings extends YpBaseElement {
    constructor() {
        super(...arguments);
        this.isOpen = false;
    }
        ...
        ${this.post && this.isOpen
            ? html `
                ...
                <div
                  ...
                  slot="content"
                >
                  ${this.post?.Group.configuration.customRatings?.map((rating, index) => {
                return html `
                        <div
    ...
    _deleteRating(event) {
        const detail = event.detail;
        window.appUser.updateRatingForPost(detail.postId, detail.ratingIndex, undefined);
        window.serverApi.deleteRating(detail.postId, detail.ratingIndex);
    }
    async open(post, refreshFunction) {
...
], YpDialogRatings.prototype, "itemName", void 0);
__decorate([
    property({ type: Boolean })
], YpDialogRatings.prototype, "isOpen", void 0);
__decorate([
    property({ type: Object })
], YpDialogRatings.prototype, "post", void 0);
__decorate([
    property({ type: Object })
], YpDialogRatings.prototype, "refreshFunction", void 0);
YpDialogRatings = __decorate([
    customElement("yp-dialog-ratings")
], YpDialogRatings);
export { YpDialogRatings };
//# sourceMappingURL=yp-dialog-ratings.js.map