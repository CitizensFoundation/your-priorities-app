...
let PlausableDevices = class PlausableDevices extends PlausibleBaseElementWithState {
    connectedCallback() {
    ...
    renderBrowsers() {
        const fetchData = () => {
            return api.get(this.proxyUrl, url.apiPath(this.site, '/browsers'), this.query);
        };
        return html `
      <pl-list-report
    ...
    renderBrowserVersions() {
        const fetchData = () => {
            return api.get(this.proxyUrl, url.apiPath(this.site, '/browser-versions'), this.query);
        };
        return html `
      <pl-list-report
        .fetchDataFunction=${fetchData}
    ...
    renderOperatingSystems() {
        const fetchData = () => {
            return api.get(this.proxyUrl, url.apiPath(this.site, '/operating-systems'), this.query);
        };
        return html `
      <pl-list-report
        .fetchDataFunction=${fetchData}
    ...
    renderOperatingSystemVersions() {
        const fetchData = () => {
            return api.get(this.proxyUrl, url.apiPath(this.site, '/operating-system-versions'), this.query);
        };
        return html `
      <pl-list-report
        .fetchDataFunction=${fetchData}
    ...
    renderScreenSizes() {
        const fetchData = () => {
            return api.get(this.proxyUrl, url.apiPath(this.site, '/screen-sizes'), this.query);
        };
        const renderIcon = (screenSize) => {
            return this.iconFor(screenSize.name);
        };
        const renderTooltipText = (screenSize) => {
...
], PlausableDevices.prototype, "tabKey", void 0);
__decorate([
    property({ type: String })
], PlausableDevices.prototype, "storedTab", void 0);
__decorate([
    property({ type: String })
], PlausableDevices.prototype, "mode", void 0);
PlausableDevices = __decorate([
    customElement('pl-devices')
], PlausableDevices);
export { PlausableDevices };
//# sourceMappingURL=pl-devices.js.map