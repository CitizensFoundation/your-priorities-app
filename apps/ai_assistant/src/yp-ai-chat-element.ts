...
export class YpAiChatElement extends YpBaseElement {
  ...
  renderRoboImage() {
    return html`
      <img
        height="32"
        width="32"
        src="https://yrpri-eu-direct-assets.s3.eu-west-1.amazonaws.com/AEdFTp47m2XBJ32jIj05vZR8cRG1mKhGzL4geUAhpTwUFg%3Ds96-c.webp"
      />
    `;
  }
          ...
          ${this.posts && this.posts.length > 0
            ? html`
                <div class="layout horizontal posts wrap">
                  ${this.posts.map(
                    post => html`
                      <div class="post layout horizontal center-justified">
  ...
  renderThinking() {
    return html` <div class="thinkingText">${this.t('Searching...')}</div> `;
  }
