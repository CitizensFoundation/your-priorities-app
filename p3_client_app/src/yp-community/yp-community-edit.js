...
Polymer({
  _template: html`
    ...
    <yp-edit-dialog name="communityEdit" id="editDialog" title="[[editHeaderText]]" icon="group-work" action="[[action]]" method="[[method]]" params="[[params]]" save-text="[[saveText]]" toast-text="[[toastText]]">
      ...
      <paper-input id="themeOverrideColorAccent" name="themeOverrideColorAccent" allowed-pattern="[#-#0-9A-Fa-f]" maxlength="7" char-counter="" label="[[t('themeOverrideColorAccent')]]" value="{{community.configuration.themeOverrideColorAccent}}">
      </paper-input>

      <paper-input id="themeOverrideBackgroundColor" name="themeOverrideBackgroundColor" allowed-pattern="[#-#0-9A-Fa-f]" maxlength="7" char-counter="" label="[[t('themeOverrideBackgroundColor')]]" value="{{community.configuration.themeOverrideBackgroundColor}}">
      </paper-input>
      ...
      <paper-input id="customBackURL" name="customBackURL" type="text" maxlength="256" label="[[t('customBackURL')]]" value="{{community.configuration.customBackURL}}">
      </paper-input>
      ...
      <paper-checkbox name="forceSecureSamlLogin" disabled\$="[[!hasSamlLoginProvider]]" checked\$="{{community.configuration.forceSecureSamlLogin}}">[[t('forceSecureSamlLogin')]]
      </paper-checkbox>

      <paper-textarea id="customSamlLoginMessage" name="customSamlLoginMessage" value="{{community.configuration.customSamlLoginMessage}}" always-float-label="[[community.configuration.customSamlLoginMessage]]" label="[[t('customSamlLoginMessage')]]" char-counter="" rows="2" max-rows="5" minlength="1" maxlength="175" class="mainInput">
      </paper-textarea>

      <paper-textarea id="customSamlDeniedMessage" name="customSamlDeniedMessage" value="{{community.configuration.customSamlDeniedMessage}}" always-float-label="[[community.configuration.customSamlDeniedMessage]]" label="[[t('customSamlDeniedMessage')]]" char-counter="" rows="2" max-rows="5" minlength="1" maxlength="150" class="mainInput">
      </paper-textarea>
      ...
      <div class="layout vertical additionalSettings half" hidden\$="[[ssnLoginListDataId]]">
        <yp-file-upload id="ssnLoginListDataUpload" raised="true" disabled\$="[[!hasSamlLoginProvider]]" hidden\$="[[!community.id]]" accept=".txt" multi="false" target="/api/communities/[[community.id]]/upload_ssn_login_list" method="POST" on-success="_ssnLoginListDataUploaded">
