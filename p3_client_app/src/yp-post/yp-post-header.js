          ...
          <div class="layout horizontal wrap mediaAndInfoContainer">
            ...
            <template is="dom-if" if="[[headerMode]]">
              <template is="dom-if" if="[[loggedInUser]]">
                <paper-menu-button vertical-align="top" horizontal-align="right" class="edit" hidden\$="[[hideActions]]">
                  <paper-icon-button aria-label\$="[[t('openPostMenu')]]" class="moreVert" icon="more-vert" slot="dropdown-trigger"></paper-icon-button>
