...
export const ypThemeBehavior = {
  ...
  _setupOverrideTheme: function (primary, accent) {
    return {
      name: 'Override theme',
      '--primary-background-color': 'var(--paper-blue-grey-100)',
  ...
  setTheme: function (number, configuration) {
    if (configuration && configuration.themeOverrideColorPrimary &&
      ...
      updateStyles(this._setupOverrideTheme(configuration.themeOverrideColorPrimary, configuration.themeOverrideColorAccent))
    } else {
