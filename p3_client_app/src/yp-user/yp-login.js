            ...
            <div class="layout vertical innerScroll">
                    ...
                    <template is="dom-if" if="[[hasSamlLogin]]">
                      <template is="dom-if" if="[[samlLoginButtonUrl]]">
                        <div class="islandIs cursor layout horizontal center-center">
                          ...
                          <div hidden\$="[[!forceSecureSamlLogin]]" class="largeSamlLogo" on-tap="_openSamlLogin">
                      ...
                      <template is="dom-if" if="[[!samlLoginButtonUrl]]">
                        <div class="islandIs cursor layout horizontal center-center">
                          <img hidden\$="[[forceSecureSamlLogin]]" on-tap="_openSamlLogin" width="80" height="18" src="https://s3.amazonaws.com/yrpri-direct-asset/yrpri6/islandisLogo.png">
                          <div hidden\$="[[!forceSecureSamlLogin]]" class="largeSamlLogo" on-tap="_openSamlLogin">
              ...
              <div hidden\$="[[forceSecureSamlLogin]]">
                <template is="dom-if" if="[[registerMode]]" restamp="">
                  <paper-input id="fullname" type="text" label="[[t('user.name')]]" value="{{name}}" maxlength="50" minlength="2" required="" char-counter="">
                  </paper-input>
                </template>

                <paper-input id="email" type="text" label="[[t('user.email')]]" value="{{email}}" name="username" autocomplete="username" pattern="[[emailValidationPattern]]" error-message="[[emailErrorMessage]]">
                </paper-input>

                <paper-input id="password" type="password" label="[[t('user.password')]]" value="{{password}}" autocomplete="current-password" error-message="[[passwordErrorMessage]]">
                </paper-input>
              </div>
            </div>
            <div class="signupTerms" hidden\$="[[!showSignupTerms]]">{{t('signupTermsInfo')}} - <span on-tap="_openTerms" class="openTerms">{{t('signupTermsOpen')}}</span>
            </div>
