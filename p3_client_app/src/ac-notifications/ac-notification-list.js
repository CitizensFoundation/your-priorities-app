            ...
            <template>
              <div tabindex\$="[[tabIndex]]" class="layout vertical overflowSettings">
                ...
                <template is="dom-if" if="[[_notificationType(notification, 'notification.generalUserNotification')]]">
                  <ac-notification-list-general-item icon="language" notification="[[notification]]" short-text="[[_getNotificationTypeAndName(notification.AcActivities.0.object.type, notification.AcActivities.0.object.name)]]"></ac-notification-list-general-item>
                </template>
              </div>
            </template>
          </iron-list>
