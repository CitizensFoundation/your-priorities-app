...
print('Reading files')
train = pandas.read_csv('../../../exporters/datasets/better_reykjavik/sentiment/train.csv', header=None)
X_train, y_train = train[1], train[0]
test = pandas.read_csv('../../../exporters/datasets/better_reykjavik/sentiment/test.csv', header=None)
