...
const getGroupIncludes = require("../services/engine/analytics/statsCalc.cjs").getGroupIncludes;
const getPointGroupIncludes = require("../services/engine/analytics/statsCalc.cjs").getPointGroupIncludes;
const getParsedSimilaritiesContent = require("../services/engine/analytics/manager.cjs").getParsedSimilaritiesContent;
const getTranslatedTextsForGroup = require("../services/utils/translation_helpers.cjs").getTranslatedTextsForGroup;
