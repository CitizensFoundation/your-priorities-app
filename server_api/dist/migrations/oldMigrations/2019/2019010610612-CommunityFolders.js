...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        return [
            ...
            await queryInterface.addIndex('communities', ['deleted', 'domain_id', 'access', 'counter_users', 'status', 'in_community_folder_id'], { name: 'ComDelDomAccCountStatInCommunity' }),
            ...
            await queryInterface.addIndex('groups', ['deleted', 'community_id', 'access', 'counter_users', 'status', 'in_group_folder_id'], { name: 'ComDelComAccCountStatInGroup' })
        ];
    },
