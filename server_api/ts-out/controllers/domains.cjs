...
router.put('/:id', auth.can('edit domain'), function (req, res) {
    models.Domain.findOne({
        ...
        if (domain) {
            ...
            domain.set('configuration.welcomeHTMLforNotLoggedInUsers', (req.body.welcomeHTMLforNotLoggedInUsers && req.body.welcomeHTMLforNotLoggedInUsers != "") ? req.body.welcomeHTMLforNotLoggedInUsers : null);
