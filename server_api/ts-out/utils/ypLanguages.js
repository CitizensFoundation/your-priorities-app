...
exports.YpLanguages = void 0;
const iso_639_1_1 = __importDefault(require("iso-639-1"));
class YpLanguages {
    static get allLanguages() {
        const allLanguages = iso_639_1_1.default.getLanguages(iso_639_1_1.default.getAllCodes()).map((language) => {
            return {
...
exports.YpLanguages = YpLanguages;
