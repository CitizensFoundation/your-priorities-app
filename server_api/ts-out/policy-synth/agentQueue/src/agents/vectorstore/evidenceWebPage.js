...
exports.EvidenceWebPageVectorStore = void 0;
const weaviate_ts_client_1 = __importDefault(require("weaviate-ts-client"));
const base_js_1 = require("../../base.js");
const constants_js_1 = require("../../constants.js");
const promises_1 = __importDefault(require("fs/promises"));
class EvidenceWebPageVectorStore extends base_js_1.Base {
    //@ts-ignore
    ...
    async addSchema() {
        let classObj;
        try {
            const data = await promises_1.default.readFile("./schemas/evidenceWebPage.json", "utf8");
...
exports.EvidenceWebPageVectorStore = EvidenceWebPageVectorStore;
