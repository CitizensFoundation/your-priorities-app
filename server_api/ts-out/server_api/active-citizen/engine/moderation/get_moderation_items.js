...
const getPushItem = (type, model) => {
    let source, toxicityScore, toxicityScoreRaw, latestContent = null, severeToxicityScore, content, lastReportedAtDate = null, firstReportedDate = null, lastReportedByEmail;
