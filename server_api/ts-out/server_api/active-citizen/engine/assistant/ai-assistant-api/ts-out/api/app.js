...
class App {
    ...
    initializeMiddlewares() {
        ...
        this.app.use(express_1.default.static(path.join(__dirname, "../../apps/policy-synth/dist")));
        this.app.use("/projects*", express_1.default.static(path.join(__dirname, "../../apps/policy-synth/dist")));
        this.app.use("/webResearch*", express_1.default.static(path.join(__dirname, "../../apps/policy-synth/dist")));
        this.app.use("/policies*", express_1.default.static(path.join(__dirname, "../../apps/policy-synth/dist")));
        this.app.use("/solutions*", express_1.default.static(path.join(__dirname, "../../apps/policy-synth/dist")));
