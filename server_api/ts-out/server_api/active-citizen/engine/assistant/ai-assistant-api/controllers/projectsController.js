...
const evidenceWebPage_js_1 = require("../../agentQueue/src/agents/vectorstore/evidenceWebPage.js");
const constants_js_1 = require("../../agentQueue/src/constants.js");
let redisClient;
...
class ProjectsController {
    ...
    evidenceWebPageVectorStore = new evidenceWebPage_js_1.EvidenceWebPageVectorStore();
    constructor() {
    ...
    getRawEvidence = async (req, res) => {
        ...
        for (const evidenceType of constants_js_1.IEngineConstants.policyEvidenceFieldTypes) {
            const searchType = constants_js_1.IEngineConstants.simplifyEvidenceType(evidenceType);
