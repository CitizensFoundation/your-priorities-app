...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        return [
            ...
            await queryInterface.createTable('PostVideo', {
                id: {
                    type: Sequelize.INTEGER,
                    primaryKey: true,
                    autoIncrement: true
            ...
            await queryInterface.createTable('PostAudio', {
                id: {
                    type: Sequelize.INTEGER,
                    primaryKey: true,
                    autoIncrement: true
            ...
            await queryInterface.createTable('PointVideo', {
                id: {
                    type: Sequelize.INTEGER,
                    primaryKey: true,
                    autoIncrement: true
            ...
            await queryInterface.createTable('PointAudio', {
                id: {
                    type: Sequelize.INTEGER,
                    primaryKey: true,
                    autoIncrement: true
            ...
            await queryInterface.createTable('UserProfileVideo', {
                id: {
                    type: Sequelize.INTEGER,
                    primaryKey: true,
                    autoIncrement: true
            ...
            await queryInterface.createTable('CommunityLogoVideo', {
                id: {
                    type: Sequelize.INTEGER,
                    primaryKey: true,
                    autoIncrement: true
            ...
            await queryInterface.createTable('GroupLogoVideo', {
                id: {
                    type: Sequelize.INTEGER,
                    primaryKey: true,
                    autoIncrement: true
            ...
            await queryInterface.createTable('DomainLogoVideo', {
                id: {
                    type: Sequelize.INTEGER,
                    primaryKey: true,
                    autoIncrement: true
            ...
            await queryInterface.createTable('VideoImage', {
                id: {
                    type: Sequelize.INTEGER,
                    primaryKey: true,
                    autoIncrement: true
