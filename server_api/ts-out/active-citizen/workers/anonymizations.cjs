...
const anonymizePointActivities = (workPackage, callback) => {
    ...
    if (pointId && workPackage.anonymousUserId) {
        async.series([
            (seriesCallback) => {
                models.AcActivity.update({ user_id: workPackage.anonymousUserId }, { where: { point_id: pointId } }).then(function (spread) {
            ...
            (seriesCallback) => {
                models.PointRevision.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { point_id: pointId, user_id: userId } }).then(function (spread) {
...
const anonymizePostActivities = (workPackage, callback) => {
    ...
    if (postId && workPackage.anonymousUserId) {
        async.series([
            (seriesCallback) => {
                models.AcActivity.update({ user_id: workPackage.anonymousUserId }, { where: { post_id: postId } }).then(function (spread) {
...
const anonymizePointContent = (workPackage, callback) => {
    ...
    if (pointId && workPackage.anonymousUserId) {
        async.series([
            ...
            (seriesCallback) => {
                models.PointQuality.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { point_id: pointId } }).then(function (spread) {
            ...
            (seriesCallback) => {
                models.PointRevision.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { point_id: pointId } }).then(function (spread) {
...
const anonymizePostContent = (workPackage, callback) => {
    ...
    if (postId && workPackage.anonymousUserId) {
        async.series([
            (seriesCallback) => {
                if (!workPackage.skipActivities) {
                    models.AcActivity.update({ user_id: workPackage.anonymousUserId }, { where: { post_id: postId } }).then((spread) => {
            ...
            (seriesCallback) => {
                models.Point.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { post_id: postId } }).then((spread) => {
            ...
            (seriesCallback) => {
                models.Endorsement.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { post_id: postId } }).then((spread) => {
...
const anonymizeGroupContent = (workPackage, callback) => {
    ...
    if (groupId && workPackage.anonymousUserId) {
        async.series([
            (seriesCallback) => {
                models.AcActivity.update({ user_id: workPackage.anonymousUserId }, { where: { group_id: groupId } }).then((spread) => {
            ...
            (seriesCallback) => {
                models.Point.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { group_id: groupId } }).then((spread) => {
            ...
            (seriesCallback) => {
                models.Post.update({ user_id: workPackage.anonymousUserId }, { where: { group_id: groupId } }).then((spread) => {
...
const anonymizeCommunityContent = (workPackage, callback) => {
    ...
    if (communityId && workPackage.anonymousUserId) {
        async.series([
            (seriesCallback) => {
                models.AcActivity.update({ user_id: workPackage.anonymousUserId }, { where: { community_id: communityId } }).then(function (spread) {
...
const anonymizeUserContent = (workPackage, callback) => {
    if (workPackage.userId && workPackage.anonymousUserId) {
        async.series([
            (seriesCallback) => {
                models.Endorsement.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { user_id: workPackage.userId } }).then((spread) => {
            ...
            (seriesCallback) => {
                models.PointQuality.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { user_id: workPackage.userId } }).then((spread) => {
            ...
            (seriesCallback) => {
                models.Point.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { user_id: workPackage.userId } }).then((spread) => {
                    log.info('User Points Anonymized', { numberDeleted: spread[0], context: 'ac-anonymize', userId: workPackage.userId });
                    seriesCallback();
                }).catch((error) => {
                    seriesCallback(error);
            ...
            (seriesCallback) => {
                models.AcActivity.update({ user_id: workPackage.anonymousUserId }, { where: { user_id: workPackage.userId } }).then((spread) => {
            ...
            (seriesCallback) => {
                models.Post.update({ user_id: workPackage.anonymousUserId, ip_address: '127.0.0.1' }, { where: { user_id: workPackage.userId } }).then((spread) => {
