...
module.exports = (sequelize, DataTypes) => {
  ...
  Domain.defaultAttributesPublic = ['id', 'name', 'domain_name', 'access', 'deleted', 'description',
  ...
  Domain.getLoginProviders = (req, domainIn, callback) => {
    ...
    async.eachSeries([domainIn], (domain, seriesCallback) => {
      ...
      if (process.env.STAGING_SETUP) {
        ...
        } else if (domain.domain_name==='multicitychallenge.org' && process.env('US-CLUSTER')!=null) {
