import{i as e,n as t,t as i,a as n,p as s,q as r,x as o,u as a,T as l,j as c,f as d,v as p,w as h,y as g,z as u,k as m,d as x,A as f,B as y,C as w,D as b}from"./22zwqnJK.js";import"./DL9tMDe8.js";import"./y3_HL5__.js";import{A as v,a as k,Y as $}from"./BP9MKvus.js";const I=e`
  .questionTitle {
    padding: 18px;
    font-size: 24px;
    padding: 8px;
...
`;var A=function(e,t,i,n){for(var s,r=arguments.length,o=r<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n,a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,i,o):s(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let T=class extends n{constructor(){super(...arguments),this.isAdmin=!1,this.footer=null,this.footerEnd=null,this.footerTopObserver=null,this.footerEndObserver=null}async connectedCallback(){super.connectedCallback(),window.appGlobals.activity("Intro - open"),this.isAdmin=s.checkGroupAccess(this.group)}disconnectedCallback(){super.disconnectedCallback(),window.appGlobals.activity("Intro - close"),this.footerTopObserver&&(this.footerTopObserver.disconnect(),this.footerTopObserver=null),this.footerEndObserver&&(this.footerEndObserver.disconnect(),this.footerEndObserver=null)}firstUpdated(){this.setupFooterObserver()}_openAnalyticsAndPromption(){r.redirectTo(`/analytics/group/${this.group.id}`)}_openAdmin(){r.redirectTo(`/admin/group/${this.group.id}`)}renderAdminButtons(){return o`
