import{n as n$4,D as YpBaseElementWithLogin,j as e$3,h as YpMediaHelpers,E as YpImage,x,T as T$1,F as YpCollectionHelpers,G as o$4,H as o$5,i as i$2,t as t$2,Y as YpBaseElement,I as YpThemeManager,J as c$2,u as YpNavHelpers,K as Corner,r as r$3,m as mixinDelegatesAria,s as s$4,_ as __decorate$l,e as e$4,M as redispatchEvent,o as o$6,z as YpStreamingLlmScrolling,O as j,y as YpFormattingHelpers,S as ShadowStyles,w as YpLanguages,g as YpEditBase,q as YpAccessHelpers}from"./BJm3h6Pu.js";import"./eL1xL4oc.js";import{G as Grid,a as addListener,b as GridColumn,r as registerStyles,i as i$3,T as ThemableMixin,h as html,D as DirMixin,P as PolymerElement,S as SlotController,c as removeValueFromAttribute,d as addValueToAttribute,e as dedupingMixin,L as LabelMixin,C as ControllerMixin,f as DelegateStateMixin,I as InputMixin,g as DelegateFocusMixin,K as KeyboardMixin,j as isTouch$1,k as Debouncer,t as timeOut,l as InputController,m as LabelledInputController,n as TooltipController,E as ElementMixin}from"./KayxMQrF.js";import{A as AoiAdminServerApi,a as AoiGenerateAiLogos}from"./finM8wnL.js";var __decorate$k=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};class YpAdminPage extends YpBaseElementWithLogin{}__decorate$k([n$4({type:String})],YpAdminPage.prototype,"collectionType",void 0),__decorate$k([n$4({type:Number})],YpAdminPage.prototype,"collectionId",void 0),__decorate$k([n$4({type:Object})],YpAdminPage.prototype,"collection",void 0);var __decorate$j=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};const defaultLtpPromptsConfiguration=()=>Object.fromEntries(Array.from({length:10},((e,t)=>[t+1,""]))),defaultLtpConfiguration={crt:{prompts:defaultLtpPromptsConfiguration(),promptsTests:defaultLtpPromptsConfiguration()}};class YpAdminConfigBase extends YpAdminPage{constructor(){super(),this.selectedTab=0,this.configChanged=!1,this.method="POST",this.generatingAiImageInBackground=!1,this.hasVideoUpload=!1,this.hasAudioUpload=!1,this.connectedVideoToCollection=!1,this.descriptionMaxLength=300,this.tabsHidden=!1,this.gettingImageColor=!1,this.imageIdsUploadedByUser=[],this.videoIdsUploadedByUser=[]}async _formResponse(e){this.configChanged=!1}_selectTab(e){this.selectedTab=e.target.activeTabIndex}async getColorFromLogo(){try{this.gettingImageColor=!0;let e=this.imagePreviewUrl||YpMediaHelpers.getImageFormatUrl(this.currentLogoImages);const t=new Image;t.src=e+"?"+(new Date).getTime(),t.setAttribute("crossOrigin",""),await t.decode();let i=await YpImage.getThemeColorsFromImage(t);this.gettingImageColor=!1,console.error("New theme color",i),i&&(i=i.replace("#",""),this.fireGlobal("yp-theme-color-detected",i),this.detectedThemeColor=i,this._configChanged())}catch(e){console.log(e)}}_updateCollection(e){this.collection=e.detail}connectedCallback(){super.connectedCallback(),this.setupBootListener(),this.addGlobalListener("yp-has-video-upload",(()=>{this.hasVideoUpload=!0})),this.addGlobalListener("yp-has-audio-upload",(()=>{this.hasAudioUpload=!0})),window.appGlobals.hasVideoUpload&&(this.hasVideoUpload=!0),window.appGlobals.hasAudioUpload&&(this.hasAudioUpload=!0),this.addListener("yp-form-response",this._formResponse),this.addListener("yp-updated-collection",this._updateCollection)}disconnectedCallback(){super.disconnectedCallback(),this.removeGlobalListener("yp-has-video-upload",(()=>{this.hasVideoUpload=!0})),this.removeGlobalListener("yp-has-audio-upload",(()=>{this.hasAudioUpload=!0})),this.removeListener("yp-form-response",this._formResponse),this.removeListener("yp-updated-collection",this._updateCollection)}_logoImageUploaded(e){var t=JSON.parse(e.detail.xhr.response);this.uploadedLogoImageId=t.id,this.imageIdsUploadedByUser.push(t.id),this.imagePreviewUrl=JSON.parse(t.formats)[0],JSON.parse(t.formats),this._configChanged()}_headerImageUploaded(e){var t=JSON.parse(e.detail.xhr.response);this.uploadedHeaderImageId=t.id,this.configChanged=!0}_statusSelected(e){const t=e.target.selectedIndex;this.status=this.collectionStatusOptions[t].name,this._configChanged()}get statusIndex(){if(this.status){for(let e=0;e<this.collectionStatusOptions.length;e++)if(this.collectionStatusOptions[e].name==this.status)return e;return-1}return-1}get collectionStatusOptions(){return this.language?[{name:"active",translatedName:this.t("status.active")},{name:"featured",translatedName:this.t("status.featured")},{name:"archived",translatedName:this.t("status.archived")},{name:"hidden",translatedName:this.t("status.hidden")}]:[]}get itemViewModeOptions(){return this.language?[{name:"list",translatedName:this.t("itemViewModeList")},{name:"grid",translatedName:this.t("itemViewModeGrid")}]:[]}_itemViewModeSelected(e){const t=e.target.selectedIndex;this.itemViewMode=this.itemViewModeOptions[t].name,this._configChanged()}get itemViewModeIndex(){if(this.itemViewMode)for(let e=0;e<this.itemViewModeOptions.length;e++)if(this.itemViewModeOptions[e].name==this.itemViewMode)return e;return 0}_getItemViewModeConfigItem(){return{text:"itemViewMode",type:"html",templateData:x`
    ...
    >
      <div class="innerTabContainer">
        ${e.map(((e,t)=>x`
            ${"html"==e.type?x`<div class="layout vertical">
                  <div
                    class="htmlItem ${"htmlContent"===e.text?"fullWidthHtmlItem":""}"
                  >
                    ${e.templateData}
                  </div>
                </div>`:x`
    ...
    `}};__decorate$i([n$4({type:String})],YpThemeColorInput.prototype,"color",void 0),__decorate$i([n$4({type:String})],YpThemeColorInput.prototype,"label",void 0),__decorate$i([n$4({type:Boolean})],YpThemeColorInput.prototype,"disableSelection",void 0),YpThemeColorInput=__decorate$i([t$2("yp-theme-color-input")],YpThemeColorInput);var __decorate$h=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpThemeSelector=class extends YpBaseElement{constructor(){super(...arguments),this.selectedThemeScheme="tonal",this.selectedThemeVariant="monochrome",this.disableSelection=!1,this.disableMultiInputs=!1,this.useLowestContainerSurface=!1,this.disableOneThemeColorInputs=!1,this.hasLogoImage=!1,this.channel=new BroadcastChannel("hex_color")}static get styles(){return[super.styles,i$2`
        md-checkbox {
          margin-right: 8px;
        }
...
<code>
  ...
  ${this.t("exampleFontStyles")}:
    ...
    `}renderPallette(){return x`<div class="wrapper">
    ...
    </div>`}};__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"oneDynamicThemeColor",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"themePrimaryColor",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"themeSecondaryColor",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"themeTertiaryColor",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"themeNeutralColor",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"themeNeutralVariantColor",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"fontStyles",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"fontImports",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"bodyBackgroundColorLight",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"bodyBackgroundColorDark",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"allBackgroundColorLight",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"allBackgroundColorDark",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"selectedThemeScheme",void 0),__decorate$h([n$4({type:String})],YpThemeSelector.prototype,"selectedThemeVariant",void 0),__decorate$h([n$4({type:Object})],YpThemeSelector.prototype,"themeConfiguration",void 0),__decorate$h([n$4({type:Boolean})],YpThemeSelector.prototype,"disableSelection",void 0),__decorate$h([n$4({type:Boolean})],YpThemeSelector.prototype,"disableMultiInputs",void 0),__decorate$h([n$4({type:Boolean})],YpThemeSelector.prototype,"useLowestContainerSurface",void 0),__decorate$h([n$4({type:Boolean})],YpThemeSelector.prototype,"disableOneThemeColorInputs",void 0),__decorate$h([n$4({type:Boolean})],YpThemeSelector.prototype,"hasLogoImage",void 0),YpThemeSelector=__decorate$h([t$2("yp-theme-selector")],YpThemeSelector);var __decorate$g=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpAdminCommunities=class extends YpBaseElementWithLogin{newCommunity(){YpNavHelpers.redirectTo(`/community/new/${this.domain.id}`)}static get styles(){return[super.styles,i$2`
        .mainContainer {
          width: 100%;
          margin-top: 32px;
        }
      ...
      `]}gotoCommunity(e,t){this.shouldHandleAnchorClick(e)&&YpNavHelpers.redirectTo(`/community/${t.id}`)}renderCommunity(e){const t=YpMediaHelpers.getImageFormatUrl(e.CommunityLogoImages),i=YpNavHelpers.withForAgentBundle(`/community/${e.id}`);return x`
      <a
        class="layout horizontal communityItem"
        href="${i}"
        @click="${t=>this.gotoCommunity(t,e)}"
        aria-label="${e.name}"
      >
        <yp-image
          class="mainImage"
    ...
    `}};__decorate$g([n$4({type:Object})],YpAdminCommunities.prototype,"domain",void 0),YpAdminCommunities=__decorate$g([t$2("yp-admin-communities")],YpAdminCommunities);var __decorate$f=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpAdminConfigDomain=class extends YpAdminConfigBase{constructor(){super(),this.action="/domains"}static get styles(){return[super.styles,i$2`
        .accessHeader {
          font-weight: bold;
          margin: 8px;
        }
    ...
    `}_hostnameChanged(){const e=this.$$("#hostname").value;this.hostnameExample=e?e+"."+window.appGlobals.domain.domain_name:"your-hostname.."+window.appGlobals.domain.domain_name,this._configChanged()}_clear(){super._clear(),this.appHomeScreenIconImageId=void 0,this.ssnLoginListDataId=void 0,this.ssnLoginListDataCount=void 0,this.inCommunityFolderId=void 0,this.signupTermsPageId=void 0,this.welcomePageId=void 0,this.availableCommunityFolders=void 0,this.$$("#appHomeScreenIconImageUpload").clear(),this._configChanged()}updated(e){e.has("collectionId")&&this.collectionId&&this._collectionIdChanged(),e.has("collection")&&this.collection&&(this.currentLogoImages=this.collection.CommunityLogoImages,this.currentHeaderImages=this.collection.CommunityHeaderImages,this._communityChanged(),this.collection.configuration.ltp?this.collection.configuration.ltp.crt.prompts||(this.collection.configuration.ltp.crt.prompts=defaultLtpPromptsConfiguration()):this.collection.configuration.ltp=defaultLtpConfiguration),super.updated(e)}languageChanged(){this._setupTranslations()}_communityChanged(){this._setupTranslations(),this.collection.CommunityLogoVideos&&this.collection.CommunityLogoVideos.length>0&&(this.uploadedVideoId=this.collection.CommunityLogoVideos[0].id),this._getHelpPages("community"),this.collection&&(0===this.collection.access?this.communityAccess="public":1===this.collection.access?this.communityAccess="closed":2===this.collection.access&&(this.communityAccess="secret"),this.collection.status&&(this.status=this.collection.status),this.collection.in_community_folder_id&&(this.inCommunityFolderId=this.collection.in_community_folder_id),this.collection.configuration&&(this.collection.configuration.signupTermsPageId&&(this.signupTermsPageId=this.collection.configuration.signupTermsPageId),this.collection.configuration.welcomePageId&&(this.welcomePageId=this.collection.configuration.welcomePageId))),window.appGlobals.hasVideoUpload?this.hasVideoUpload=!0:this.hasVideoUpload=!1,window.appGlobals.domain&&window.appGlobals.domain.samlLoginProvided?this.hasSamlLoginProvider=!0:this.hasSamlLoginProvider=!1,this.collection&&this.collection.configuration&&this.collection.configuration.ssnLoginListDataId&&(this.ssnLoginListDataId=this.collection.configuration.ssnLoginListDataId,this._getSsnListCount()),this.requestUpdate()}_deleteSsnLoginList(){this.collection&&this.ssnLoginListDataId&&(window.adminServerApi.deleteSsnLoginList(this.collection.id,this.ssnLoginListDataId),this.ssnLoginListDataId=void 0,this.ssnLoginListDataCount=void 0)}_ssnLoginListDataUploaded(e){this.ssnLoginListDataId=JSON.parse(e.detail.xhr.response).ssnLoginListDataId,this._getSsnListCount(),this._configChanged()}async _getSsnListCount(){if(this.collection&&this.ssnLoginListDataId){const e=await window.adminServerApi.getSsnListCount(this.collection.id,this.ssnLoginListDataId);this.ssnLoginListDataCount=e.count}}async _collectionIdChanged(){"new"==this.collectionId||"newFolder"==this.collectionId?(this.action=`/communities/${this.parentCollectionId}`,this.collection={id:-1,name:"",description:"",access:2,status:"active",only_admins_can_create_groups:!0,counter_points:0,counter_posts:0,counter_users:0,configuration:{ltp:defaultLtpConfiguration},hostname:"",is_community_folder:"newFolder"==this.collectionId},await this.checkDomainName(this.parentCollectionId),this.parentCollection&&this.parentCollection.configuration.theme&&(this.collection.configuration.theme=this.parentCollection.configuration.theme)):(this.action=`/communities/${this.collectionId}`,await this.checkDomainName(this.collection.Domain.id))}async checkDomainName(e){const t=await window.serverApi.getCollection("domain",e);if(this.collection.Domain=t,this.collection&&this.collection.Domain&&this.collection.Domain?.domain_name){this.collection.Domain.domain_name.includes(".")?this.hideHostnameInput=!1:(this.collection.hostname||(this.collection.hostname=this._generateRandomHostname()),this.hideHostnameInput=!0)}}async _checkCommunityFolders(e){let t;t=e.Domain?e.Domain:window.appGlobals.domain;const i=await window.adminServerApi.getCommunityFolders(t.id);var o;i&&this.collection?.id&&(i.forEach(((e,t)=>{e.id==this.collection?.id&&(o=t)})),o&&i.splice(o,1));i&&i.length>0?(i.unshift({id:-1,name:this.t("none")}),this.availableCommunityFolders=i):this.availableCommunityFolders=void 0}_setupTranslations(){"new"==this.collectionId?(this.collection&&this.collection.is_community_folder?this.editHeaderText=this.t("newCommunityFolder"):this.editHeaderText=this.t("community.new"),this.saveText=this.t("create"),this.toastText=this.t("communityToastCreated")):(this.collection&&this.collection.is_community_folder?this.editHeaderText=this.t("updateCommunityFolder"):this.editHeaderText=this.t("Update community info"),this.saveText=this.t("save"),this.toastText=this.t("communityToastUpdated"))}async _formResponse(e){super._formResponse(e);const t=e.detail;t?t.hostnameTaken?window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("hostnameTaken"),void 0)})):this.uploadedVideoId&&this.connectedVideoToCollection?(await window.adminServerApi.addVideoToCollection(t.id,{videoId:this.uploadedVideoId},"community"),this._finishRedirect(t)):this._finishRedirect(t):console.warn("No community found on custom redirect")}_finishRedirect(e){"new"==this.collectionId&&window.appUser.recheckAdminRights(),e.is_community_folder?YpNavHelpers.redirectTo("/community_folder/"+e.id):YpNavHelpers.redirectTo("/community/"+e.id),window.appGlobals.activity("completed","editCommunity")}_accessRadioChanged(e){this.communityAccess=e.target.value,this._configChanged()}_getAccessTab(){return{name:"access",icon:"code",items:[{text:"status",type:"html",templateData:x`
          ...
          `},{text:"onlyAdminsCanCreateGroups",type:"checkbox",value:this.collection.only_admins_can_create_groups,translationToken:"community.onlyAdminsCanCreateGroups"},{text:"enableFraudDetection",type:"checkbox",value:this.collection.configuration.enableFraudDetection,translationToken:"enableFraudDetection"},{text:"alwaysShowOnDomainPage",type:"checkbox",value:this.collection.configuration.alwaysShowOnDomainPage,translationToken:"alwaysShowOnDomainPage"},{text:"useAsTemplate",type:"checkbox",value:this.collection.configuration.useAsTemplate,translationToken:"useAsTemplate"}]}}_getBasicTab(){return{name:"basic",icon:"code",items:[{text:"defaultLocale",type:"html",templateData:x`
            <yp-language-selector
              name="defaultLocale"
              noUserEvents
              @changed="${this._configChanged}"
          ...
          `},{text:"mediaUploads",type:"html",templateData:this.renderHeaderImageUploads()},{text:"alwaysHideLogoImage",type:"checkbox"},{text:"facebookPixelId",type:"textfield",maxLength:40},{text:"redirectToGroupId",type:"textfield",maxLength:40},{text:"defaultLocationLongLat",type:"textfield",maxLength:100,value:this.collection.defaultLocationLongLat},{text:"inCommunityFolder",type:"html",templateData:x`
            <md-outlined-select
              ...
              .value="${o$5(null!=this.inCommunityFolderId?String(this.inCommunityFolderId):"")}"
            >
          ...
          `,hidden:!this.availableCommunityFolders},{text:"signupTermsSelectPage",type:"html",templateData:x`
            <md-outlined-select
              ...
              .value="${o$5(null!=this.signupTermsPageId?String(this.signupTermsPageId):"")}"
            >
              <md-select-option value="">
                ${this.t("none")}
              </md-select-option>
          ...
          `,hidden:!this.translatedPages},{text:"welcomePageSelect",type:"html",templateData:x`
            <md-outlined-select
              ...
              .value="${o$5(null!=this.welcomePageId?String(this.welcomePageId):"")}"
            >
              <md-select-option value="">
                ${this.t("none")}
              </md-select-option>
              ${this.translatedPages?.map(((e,t)=>x`
                  <md-select-option
                    value="${e.id}"
                    ?selected="${this.welcomePageId==e.id}"
                    >${this._getLocalizePageTitle(e)}</md-select-option
                  >
                `))}
            </md-outlined-select>
          `,hidden:!this.translatedPages}]}}_welcomePageSelected(e){const t=e.target.value;this.welcomePageId=t?Number(t):void 0,this._configChanged()}_signupTermsPageSelected(e){const t=e.target.value;this.signupTermsPageId=t?Number(t):void 0,this._configChanged()}_communityFolderSelected(e){const t=e.target.value;this.inCommunityFolderId=t?Number(t):void 0,this._configChanged()}_getLookAndFeelTab(){return{name:"lookAndFeel",icon:"code",items:[{text:"themeSelector",type:"html",templateData:x`
            <yp-theme-selector
              @config-updated="${this._configChanged}"
              ?hasLogoImage="${this.imagePreviewUrl||YpMediaHelpers.getImageFormatUrl(this.currentLogoImages)}"
              @get-color-from-logo="${this.getColorFromLogo}"
    ...
    `}};__decorate$e([n$4({type:Number})],YpAdminConfigCommunity.prototype,"appHomeScreenIconImageId",void 0),__decorate$e([n$4({type:String})],YpAdminConfigCommunity.prototype,"hostnameExample",void 0),__decorate$e([n$4({type:Boolean})],YpAdminConfigCommunity.prototype,"hasSamlLoginProvider",void 0),__decorate$e([n$4({type:Array})],YpAdminConfigCommunity.prototype,"availableCommunityFolders",void 0),__decorate$e([n$4({type:Number})],YpAdminConfigCommunity.prototype,"ssnLoginListDataId",void 0),__decorate$e([n$4({type:Number})],YpAdminConfigCommunity.prototype,"ssnLoginListDataCount",void 0),__decorate$e([n$4({type:Number})],YpAdminConfigCommunity.prototype,"inCommunityFolderId",void 0),__decorate$e([n$4({type:Number})],YpAdminConfigCommunity.prototype,"signupTermsPageId",void 0),__decorate$e([n$4({type:Number})],YpAdminConfigCommunity.prototype,"welcomePageId",void 0),__decorate$e([n$4({type:String})],YpAdminConfigCommunity.prototype,"communityAccess",void 0),__decorate$e([n$4({type:Boolean})],YpAdminConfigCommunity.prototype,"hideHostnameInput",void 0),__decorate$e([n$4({type:Array})],YpAdminConfigCommunity.prototype,"templates",void 0),__decorate$e([n$4({type:Boolean})],YpAdminConfigCommunity.prototype,"cloning",void 0),__decorate$e([n$4({type:Number})],YpAdminConfigCommunity.prototype,"cloningTemplateId",void 0),YpAdminConfigCommunity=__decorate$e([t$2("yp-admin-config-community")],YpAdminConfigCommunity);var __decorate$d=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpAdminHtmlEditor=class extends YpBaseElement{constructor(){super(...arguments),this.content="",this.media=[],this.selectedTab=0,this.mediaLoaded={},this.generatingAiImageInBackground=!1,this.hasVideoUpload=!1,this.browserPreviewType="desktop",this.imageIdsUploadedByUser=[],this.videoIdsUploadedByUser=[]}_selectTab(e){this.selectedTab=e.currentTarget.activeTabIndex}getConfiguration(){return console.log(JSON.stringify({content:this.content,media:this.media})),{content:this.content,media:this.media}}connectedCallback(){super.connectedCallback(),this.addGlobalListener("yp-has-video-upload",(()=>{this.hasVideoUpload=!0})),window.appGlobals.hasVideoUpload&&(this.hasVideoUpload=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeGlobalListener("yp-has-video-upload",(()=>{this.hasVideoUpload=!0}))}static get styles(){return[super.styles,i$2`
        :host {
          display: block;
          width: 100%;
        }
    ...
    `}changed(e){e.currentTarget?this.content=e.currentTarget.value:this.content=e.detail.value,this.contentChanged()}debouncedSave(){this.debounceTimer&&clearTimeout(this.debounceTimer),this.debounceTimer=window.setTimeout((()=>{}),1e4)}};__decorate$d([n$4({type:String})],YpAdminHtmlEditor.prototype,"content",void 0),__decorate$d([n$4({type:Array})],YpAdminHtmlEditor.prototype,"media",void 0),__decorate$d([n$4({type:Number})],YpAdminHtmlEditor.prototype,"selectedTab",void 0),__decorate$d([r$3()],YpAdminHtmlEditor.prototype,"mediaLoaded",void 0),__decorate$d([n$4({type:Boolean})],YpAdminHtmlEditor.prototype,"generatingAiImageInBackground",void 0),__decorate$d([n$4({type:Object})],YpAdminHtmlEditor.prototype,"group",void 0),__decorate$d([n$4({type:Number})],YpAdminHtmlEditor.prototype,"parentCollectionId",void 0),__decorate$d([n$4({type:Number})],YpAdminHtmlEditor.prototype,"mediaIdToDelete",void 0),__decorate$d([n$4({type:String})],YpAdminHtmlEditor.prototype,"collectionId",void 0),__decorate$d([n$4({type:Boolean})],YpAdminHtmlEditor.prototype,"hasVideoUpload",void 0),__decorate$d([n$4({type:String})],YpAdminHtmlEditor.prototype,"browserPreviewType",void 0),__decorate$d([n$4({type:Array})],YpAdminHtmlEditor.prototype,"imageIdsUploadedByUser",void 0),__decorate$d([n$4({type:Array})],YpAdminHtmlEditor.prototype,"videoIdsUploadedByUser",void 0),YpAdminHtmlEditor=__decorate$d([t$2("yp-admin-html-editor")],YpAdminHtmlEditor);
/**
 * @license
 ...
 */class Chip extends chipBaseClass{get rippleDisabled(){return this.disabled||this.softDisabled}constructor(){super(),this.disabled=!1,this.softDisabled=!1,this.alwaysFocusable=!1,this.label="",this.hasIcon=!1,this.addEventListener("click",this.handleClick.bind(this))}focus(e){this.disabled&&!this.alwaysFocusable||super.focus(e)}render(){return x`
    ...
    `}handleIconChange(e){const t=e.target;this.hasIcon=t.assignedElements({flatten:!0}).length>0}handleClick(e){if(this.softDisabled||this.disabled&&this.alwaysFocusable)return e.stopImmediatePropagation(),void e.preventDefault()}}Chip.shadowRootOptions={...s$4.shadowRootOptions,delegatesFocus:!0},__decorate$l([n$4({type:Boolean,reflect:!0})],Chip.prototype,"disabled",void 0),__decorate$l([n$4({type:Boolean,attribute:"soft-disabled",reflect:!0})],Chip.prototype,"softDisabled",void 0),__decorate$l([n$4({type:Boolean,attribute:"always-focusable"})],Chip.prototype,"alwaysFocusable",void 0),__decorate$l([n$4()],Chip.prototype,"label",void 0),__decorate$l([n$4({type:Boolean,reflect:!0,attribute:"has-icon"})],Chip.prototype,"hasIcon",void 0);
/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */class FilterChip extends MultiActionChip{constructor(){super(...arguments),this.elevated=!1,this.removable=!1,this.selected=!1,this.hasSelectedIcon=!1}get primaryId(){return"button"}getContainerClasses(){return{...super.getContainerClasses(),elevated:this.elevated,selected:this.selected,"has-trailing":this.removable,"has-icon":this.hasIcon||this.selected}}renderPrimaryAction(e){const{ariaLabel:t}=this;return x`
    ...
    `:super.renderLeadingIcon()}renderTrailingAction(e){return this.removable?renderRemoveButton({focusListener:e,ariaLabel:this.ariaLabelRemove,disabled:this.disabled||this.softDisabled}):T$1}renderOutline(){return this.elevated?x`<md-elevation part="elevation"></md-elevation>`:super.renderOutline()}handleClickOnChild(e){if(this.disabled||this.softDisabled)return;const t=this.selected;this.selected=!this.selected;!redispatchEvent(this,e)&&(this.selected=t)}}__decorate$l([n$4({type:Boolean})],FilterChip.prototype,"elevated",void 0),__decorate$l([n$4({type:Boolean})],FilterChip.prototype,"removable",void 0),__decorate$l([n$4({type:Boolean,reflect:!0})],FilterChip.prototype,"selected",void 0),__decorate$l([n$4({type:Boolean,reflect:!0,attribute:"has-selected-icon"})],FilterChip.prototype,"hasSelectedIcon",void 0),__decorate$l([e$3(".primary.action")],FilterChip.prototype,"primaryAction",void 0),__decorate$l([e$3(".trailing.action")],FilterChip.prototype,"trailingAction",void 0);
/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */;let MdChipSet=class extends ChipSet{};MdChipSet.styles=[styles],MdChipSet=__decorate$l([t$2("md-chip-set")],MdChipSet);var __decorate$c=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let AoiEarlIdeasEditor=class extends YpStreamingLlmScrolling{constructor(){super(),this.openForAnswers=!1,this.isGeneratingWithAi=!1,this.isSubmittingIdeas=!1,this.isFetchingChoices=!1,this.currentIdeasFilter="latest",this.scrollElementSelector="#answers",this.serverApi=new AoiAdminServerApi,this.shouldContinueGenerating=!0,this.currentGeneratingIndex=void 0}connectedCallback(){this.createGroupObserver(),this.setupBootListener(),this.imageGenerator=new AoiGenerateAiLogos(this.themeColor),this.configuration.earl&&this.configuration.earl.question_id?(this.disableWebsockets=!0,this.isCreatingIdeas=!1,this.getChoices()):this.isCreatingIdeas=!0,super.connectedCallback(),this.addEventListener("yp-ws-closed",this.socketClosed),this.addEventListener("yp-ws-error",this.socketError),this.addGlobalListener("yp-theme-configuration-updated",this.themeUpdated.bind(this))}disconnectedCallback(){this.removeEventListener("yp-ws-closed",this.socketClosed),this.removeEventListener("yp-ws-error",this.socketError),this.removeGlobalListener("yp-theme-configuration-updated",this.themeUpdated.bind(this)),super.disconnectedCallback()}themeUpdated(e){this.imageGenerator=new AoiGenerateAiLogos(e.detail.oneDynamicColor||e.detail.primaryColor||this.themeColor),this.requestUpdate()}socketClosed(){this.isGeneratingWithAi=!1}socketError(){this.isGeneratingWithAi=!1}async getChoices(){this.choices=await this.serverApi.getChoices(this.domainId,this.communityId,this.configuration.earl.question_id)}createGroupObserver(){const e={set:(e,t,i,o)=>(console.error(`Property ${String(t)} set to`,i),this.handleGroupChange(),Reflect.set(e,t,i,o))};this.group=new Proxy(this.group,e)}handleGroupChange(){console.error("Group changed",this.group)}async addChatBotElement(e){switch(e.type){case"start":case"moderation_error":break;case"error":this.isGeneratingWithAi=!1;break;case"end":this.isGeneratingWithAi=!1,this.answersElement.value+="\n";break;case"stream":if(e.message&&"undefined"!=e.message){this.answersElement.value+=e.message,this.answersElement.value=this.answersElement.value.replace(/\n\n/g,"\n");break}console.warn("stream message is undefined")}this.scrollDown()}get answers(){return this.$$("#answers")?.value.split("\n").map((e=>e.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/\t/g,"\\t"))).filter((e=>e.length>0))}hasMoreThanOneIdea(){}openMenuFor(e){console.log("openMenuFor",e)}generateIdeas(){this.isGeneratingWithAi=!0;try{this.serverApi.startGenerateIdeas(this.configuration.earl.question.name,this.domainId,this.communityId,this.wsClientId,this.answers)}catch(e){console.error(e)}}async submitIdeasForCreation(){this.isSubmittingIdeas=!0;try{const{question_id:e}=await this.serverApi.submitIdeasForCreation(this.domainId,this.communityId,this.answers,this.configuration.earl.question.name);this.configuration.earl.question_id=e,this.configuration.earl.active=!0,this.configuration.earl.configuration||(this.configuration.earl.configuration={}),this.configuration.earl.question||(this.configuration.earl.question={}),this.configuration.earl.question.id=e,this.fire("configuration-changed",this.configuration),this.requestUpdate(),this.getChoices()}catch(e){console.error(e)}finally{this.isSubmittingIdeas=!1}}toggleIdeaActivity(e){return async()=>{this.isTogglingIdeaActive=e.id;try{e.active=!e.active,await this.serverApi.updateActive(this.domainId,this.communityId,this.configuration.earl.question_id,e.id,e.active)}catch(e){console.error(e)}finally{this.isTogglingIdeaActive=void 0}this.requestUpdate()}}applyFilter(e){this.currentIdeasFilter=e}get sortedChoices(){if(this.choices)switch(this.currentIdeasFilter){case"latest":return this.choices.sort(((e,t)=>t.id-e.id));case"highestScore":return this.choices.sort(((e,t)=>t.score-e.score));case"activeDeactive":return this.choices.sort(((e,t)=>t.active<e.active?-1:t.active>e.active?1:0))}}updated(e){super.updated(e)}async generateAiIcons(){this.isGeneratingWithAi=!0,this.shouldContinueGenerating=!0,this.rateLimitError=void 0;const e=this.choices.filter((e=>!e.data?.imageUrl)),t=async e=>{if(!this.shouldContinueGenerating)return;const t=new AoiGenerateAiLogos(this.themeColor);this.communityId?(t.collectionType="community",t.collectionId=this.communityId):this.domainId&&(t.collectionType="domain",t.collectionId=this.domainId),e.data.isGeneratingImage=!0,this.requestUpdate();try{const i=await t.generateIcon(e.data.content,this.$$("#aiStyleInput").value);if(e.data.isGeneratingImage=void 0,i.error)return void console.error(i.error);if(!this.shouldContinueGenerating)return;i.imageUrl&&(await this.serverApi.updateChoice(this.domainId,this.communityId,this.configuration.earl.question_id,e.id,{content:e.data.content,imageUrl:i.imageUrl,choiceId:e.id}),e.data.imageUrl=i.imageUrl,this.fire("configuration-changed",this.configuration),this.requestUpdate())}catch(i){e.data.isGeneratingImage=!1,"rate_limited"===i.error&&(this.rateLimitError=t.formatRateLimitError(i),this.shouldContinueGenerating=!1,window.appGlobals.showToast(this.rateLimitError,1e4)),console.error(i)}};let i=0;const o=Array.from({length:Math.min(5,e.length)},(async()=>{for(;this.shouldContinueGenerating&&i<e.length;){const o=e[i++];await t(o)}}));await Promise.all(o),this.isGeneratingWithAi=!1,this.currentGeneratingIndex=void 0}async generateAiIconsOld(){this.imageGenerator.collectionType="community",this.imageGenerator.collectionId=this.communityId,this.isGeneratingWithAi=!0,this.shouldContinueGenerating=!0,this.rateLimitError=void 0;for(let e=0;e<this.choices.length&&this.shouldContinueGenerating;e++){const t=this.choices[e];if(!t.data?.imageUrl){this.currentGeneratingIndex=e;try{t.data.isGeneratingImage=!0;const{imageUrl:e,error:i}=await this.imageGenerator.generateIcon(t.data.content,this.$$("#aiStyleInput").value);if(t.data.isGeneratingImage=void 0,i){console.error(i);continue}if(!this.shouldContinueGenerating)break;await this.serverApi.updateChoice(this.domainId,this.communityId,this.configuration.earl.question_id,t.id,{content:t.data.content,imageUrl:e,choiceId:t.id}),t.data.imageUrl=e,console.error("imageUrl",e,"error",i),this.requestUpdate()}catch(e){t.data.isGeneratingImage=!1,"rate_limited"===e.error&&(this.rateLimitError=this.imageGenerator.formatRateLimitError(e),this.shouldContinueGenerating=!1,window.appGlobals.showToast(this.rateLimitError,1e4)),console.error(e)}}}this.isGeneratingWithAi=!1,this.currentGeneratingIndex=void 0}stopGenerating(){this.shouldContinueGenerating=!1,this.isGeneratingWithAi=!1,this.choices&&void 0!==this.currentGeneratingIndex&&(this.choices[this.currentGeneratingIndex].data.isGeneratingImage=!1,this.requestUpdate())}get allChoicesHaveIcons(){return this.choices?.every((e=>e.data.imageUrl))}async deleteImageUrl(e){e.data.imageUrl=void 0,await this.serverApi.updateChoice(this.domainId,this.communityId,this.configuration.earl.question_id,e.id,{content:e.data.content,imageUrl:void 0,choiceId:e.id}),this.requestUpdate()}static get styles(){return[super.styles,i$2`
    ...
    `}renderBeforeTabPages(){return this.group?.id&&this.group.configuration.actAsLinkToCommunityId?x`<div class="layout horizontal allGroupMenus">
          <a href="/group/${this.group.id}" target="_blank">
            ${this.t("fullGroupLinkMenus")}
          </a>
        </div>`:T$1}renderHeader(){return this.collection?x`
          <div class="layout horizontal wrap topInputContainer">
            <div class="layout vertical">
              ${this.renderLogoMedia()}
    ...
    `}_validateJson(e,t){let i=!1;if(e){const t=e.trim();if(t.startsWith("[")||t.startsWith("{"))try{JSON.parse(t)}catch(e){i=!0,console.error("JSON validation error:",e)}}this[t]=i,this.requestUpdate(t)}_structuredQuestionsChanged(e){const t=e.target.value;this.group.configuration&&(this.group.configuration.structuredQuestions=t,this._validateJson(t,"structuredQuestionsJsonError"),this._configChanged())}_registrationQuestionsChanged(e){const t=e.target.value;this.group.configuration&&(this.group.configuration.registrationQuestions=t,this._validateJson(t,"registrationQuestionsJsonError"),this._configChanged())}};YpAdminConfigGroup.GroupType={ideaGeneration:0,allOurIdeas:1,htmlContent:2,policySynthAgentsWorkflow:3},__decorate$b([n$4({type:Number})],YpAdminConfigGroup.prototype,"appHomeScreenIconImageId",void 0),__decorate$b([n$4({type:String})],YpAdminConfigGroup.prototype,"hostnameExample",void 0),__decorate$b([n$4({type:Number})],YpAdminConfigGroup.prototype,"signupTermsPageId",void 0),__decorate$b([n$4({type:Number})],YpAdminConfigGroup.prototype,"welcomePageId",void 0),__decorate$b([n$4({type:String})],YpAdminConfigGroup.prototype,"aoiQuestionName",void 0),__decorate$b([n$4({type:String})],YpAdminConfigGroup.prototype,"groupAccess",void 0),__decorate$b([n$4({type:Number})],YpAdminConfigGroup.prototype,"groupTypeIndex",void 0),__decorate$b([n$4({type:Object})],YpAdminConfigGroup.prototype,"group",void 0),__decorate$b([n$4({type:Boolean})],YpAdminConfigGroup.prototype,"cloning",void 0),__decorate$b([n$4({type:Array})],YpAdminConfigGroup.prototype,"templates",void 0),__decorate$b([n$4({type:Number})],YpAdminConfigGroup.prototype,"cloningTemplateId",void 0),__decorate$b([n$4({type:String})],YpAdminConfigGroup.prototype,"apiEndpoint",void 0),YpAdminConfigGroup=YpAdminConfigGroup_1=__decorate$b([t$2("yp-admin-config-group")],YpAdminConfigGroup);var __decorate$a=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpAdminGroups=class extends YpBaseElementWithLogin{newGroup(){YpNavHelpers.redirectTo(`/group/new/${this.community.id}`)}static get styles(){return[super.styles,i$2`
        .mainContainer {
          width: 100%;
          margin-top: 32px;
        }
      ...
      `]}gotoGroup(e,t){this.shouldHandleAnchorClick(e)&&YpNavHelpers.redirectTo(`/group/${t.id}`)}renderGroup(e){const t=YpMediaHelpers.getImageFormatUrl(e.GroupLogoImages),i=YpNavHelpers.withForAgentBundle(`/group/${e.id}`);return x`
      <a
        class="layout horizontal groupItem"
        href="${i}"
        @click="${t=>this.gotoGroup(t,e)}"
        aria-label="${e.name}"
      >
        <yp-image
          class="mainImage"
    ...
    `}};__decorate$a([n$4({type:Object})],YpAdminGroups.prototype,"community",void 0),YpAdminGroups=__decorate$a([t$2("yp-admin-groups")],YpAdminGroups);
/**
 * @license
...
class GridFilterColumn extends GridColumn{static get is(){return"vaadin-grid-filter-column"}static get properties(){return{path:String,header:String}}static get observers(){return["_onHeaderRendererOrBindingChanged(_headerRenderer, _headerCell, path, header, _filterValue)"]}constructor(){super(),this.__boundOnFilterValueChanged=this.__onFilterValueChanged.bind(this)}_defaultHeaderRenderer(e,t){let i=e.firstElementChild,o=i?i.firstElementChild:void 0;i||(i=document.createElement("vaadin-grid-filter"),o=document.createElement("vaadin-text-field"),o.setAttribute("slot","filter"),o.setAttribute("theme","small"),o.setAttribute("style","max-width: 100%;"),o.setAttribute("focus-target",""),o.addEventListener("value-changed",this.__boundOnFilterValueChanged),i.appendChild(o),e.appendChild(i)),i.path=this.path,i.value=this._filterValue,o.__rendererValue=this._filterValue,o.value=this._filterValue,o.label=this.__getHeader(this.header,this.path)}_computeHeaderRenderer(){return this._defaultHeaderRenderer}__onFilterValueChanged(e){e.detail.value!==e.target.__rendererValue&&(this._filterValue=e.detail.value)}__getHeader(e,t){return e||(t?this._generateHeader(t):void 0)}}customElements.define(GridFilterColumn.is,GridFilterColumn);var __decorate$9=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpUsersGrid=class extends YpBaseElement{updated(e){super.updated(e),e.has("groupId")&&this._groupIdChanged(),e.has("communityId")&&this._communityIdChanged(),e.has("domainId")&&this._domainIdChanged(),e.has("adminUsers")&&this.users&&(this.showReload=!1,this._reload()),this._setupHeaderText()}static get styles(){return[super.styles,i$2`
    ...
    `}get spinnerActive(){return!this.totalUserCount||this.forceSpinner}async _generateRequest(e=void 0){e?this.lastFethedId=e:e=this.lastFethedId;const t=this.adminUsers?"admin_users":"users",i=await window.adminServerApi.adminMethod(`/api/${this.modelType}/${e}/${t}`,"GET");this._usersResponse({detail:i})}async _ajaxError(e=void 0){this.forceSpinner=!1}constructor(e){super(),this.adminUsers=!1,this.selectedUsersCount=0,this.selectedUsersEmpty=!0,this.showReload=!1,this.forceSpinner=!1,this.inviteType="sendInviteByEmail",this.collectionName=e}connectedCallback(){super.connectedCallback(),this._setGridSize(),window.addEventListener("resize",this._resizeThrottler.bind(this),!1)}async _reload(){try{await this._generateRequest(),this.forceSpinner=!0}catch(e){this._ajaxError()}finally{this.forceSpinner=!1}}_resizeThrottler(){this.resizeTimeout||(this.resizeTimeout=window.setTimeout((()=>{this.resizeTimeout=void 0,this._setGridSize()}),66))}_setGridSize(){this.gridElement&&(window.innerWidth<=600?this.gridElement.style.height=`${window.innerHeight}px`:this.gridElement.style.height=.8*window.innerHeight+"px")}_menuSelection(e){const t=this.shadowRoot?.querySelectorAll("md-menu");t?.forEach((e=>{e.select("")}))}get totalUserCount(){return this.users?YpFormattingHelpers.number(this.users.length):null}_selectedUsersChanged(e){e.detail&&e.detail.value&&(this.selectedUsers=e.detail.value),this.selectedUsers&&this.selectedUsers.length>0?(this.selectedUsersEmpty=!1,this.selectedUsersCount=this.selectedUsers.length,this.selectedUserIds=this.selectedUsers.map((e=>e.id))):(this.selectedUsersEmpty=!0,this.selectedUsersCount=0,this.selectedUserIds=[])}_userOrganizationId(e){return e&&e.OrganizationUsers&&e.OrganizationUsers.length>0?e.OrganizationUsers[0].id:null}_userOrganizationName(e){return e&&e.OrganizationUsers&&e.OrganizationUsers.length>0?e.OrganizationUsers[0].name:null}_availableOrganizations(){return window.appUser.adminRights?.OrganizationAdmins||[]}async _addToOrganization(e){this.userIdForSelectingOrganization=parseInt(e.target.getAttribute("data-args")),this.availableOrganizations=this._availableOrganizations(),this.shadowRoot.getElementById("selectOrganizationDialog").show()}closeOrganizationDialog(){this.shadowRoot.getElementById("selectOrganizationDialog").close()}async _removeFromOrganization(e){const t=e.target,i=t.getAttribute("data-args"),o=t.getAttribute("data-args-org");try{await window.adminServerApi.removeUserFromOrganization(parseInt(o),parseInt(i)),this._reload()}catch(e){this._ajaxError(e)}}async _selectOrganization(e){const t=e.target.id;try{await window.adminServerApi.addUserToOrganization(parseInt(t),this.userIdForSelectingOrganization),this.shadowRoot.getElementById("selectOrganizationDialog").close(),this._reload()}catch(e){this._ajaxError(e)}}async _removeAdmin(e){const t=parseInt(e.target.getAttribute("data-args"));try{"groups"===this.modelType&&this.groupId?await window.adminServerApi.removeAdmin("groups",this.groupId,t):"communities"===this.modelType&&this.communityId?await window.adminServerApi.removeAdmin("communities",this.communityId,t):"domains"===this.modelType&&this.domainId?await window.adminServerApi.removeAdmin("domains",this.domainId,t):console.warn("Can't find model type or ids"),this._reload()}catch(e){this._ajaxError(e)}}_removeSelectedAdmins(e){this._setupUserIdFromEvent(e),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureYouWantToRemoveAdmins"),this._reallyRemoveSelectedAdmins.bind(this),!0,!1)}))}_removeAndDeleteContentSelectedUsers(e){this._setupUserIdFromEvent(e),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureRemoveAndDeleteSelectedUserContent"),this._reallyRemoveAndDeleteContentSelectedUsers.bind(this),!0,!0)}))}_removeSelectedUsersFromCollection(e){this._setupUserIdFromEvent(e),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureRemoveSelectedUsers"),this._reallyRemoveSelectedUsersFromCollection.bind(this),!0,!0)}))}_removeUserFromCollection(e){this._setupUserIdFromEvent(e),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureRemoveUser"),this._reallyRemoveUserFromCollection.bind(this),!0,!1)}))}_removeAndDeleteUserContent(e){this._setupUserIdFromEvent(e),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureRemoveAndDeleteUser"),this._reallyRemoveAndDeleteUserContent.bind(this),!0,!0)}))}async _removeMaster(e,t=void 0){let i,o;if("groups"===this.modelType&&this.groupId)o=this.groupId;else if("communities"===this.modelType&&this.communityId)o=this.communityId;else{if("domains"!==this.modelType||!this.domainId)return void console.error("Can't find model type or ids");o=this.domainId}if(t&&t.length>0)i=`/api/${this.modelType}/${o}/${e}`;else{if(!this.selectedUserId)return void console.error("No user ids to remove");i=`/api/${this.modelType}/${o}/${this.selectedUserId}/${e}`}const n=t?{userIds:t}:{};try{this.forceSpinner=!0,await window.adminServerApi.adminMethod(i,"DELETE",n),this._manyItemsResponse(!0)}catch(e){console.error(e),this._ajaxError(e)}finally{this.forceSpinner=!1}if(this.selectedUserId){const e=this._findUserFromId(this.selectedUserId);e&&this.gridElement instanceof GridElement&&this.gridElement.deselectItem(e)}}async _reallyRemoveSelectedAdmins(){await this._removeMaster("remove_many_admins",this.selectedUserIds)}async _reallyRemoveAndDeleteContentSelectedUsers(){await this._removeMaster("remove_many_users_and_delete_content",this.selectedUserIds)}async _reallyRemoveSelectedUsersFromCollection(){await this._removeMaster("remove_many_users",this.selectedUserIds)}async _reallyRemoveUserFromCollection(){await this._removeMaster("remove_user")}async _reallyRemoveAndDeleteUserContent(){await this._removeMaster("remove_and_delete_user_content")}_setupUserIdFromEvent(e){const t=e.target;let i=t.parentElement.getAttribute("data-args");i||(i=t.getAttribute("data-args")),i&&(this.selectedUserId=parseInt(i))}_openAllMenu(e){this.$$("#allUsersMenu").open=!0}_setSelected(e){const t=e.target.getAttribute("data-args");if(t){const e=this._findUserFromId(parseInt(t));e&&this.$$("#grid").selectItem(e)}setTimeout((()=>{this.$$(`#userItemMenu${t}`).open=!0}))}_findUserFromId(e){let t;return this.users.forEach((i=>{i.id==e&&(t=i)})),t}async _addAdmin(e){try{let e;if("groups"===this.modelType&&this.groupId&&this.addAdminEmail)e=await window.adminServerApi.addAdmin("groups",this.groupId,this.addAdminEmail.value);else if("communities"===this.modelType&&this.communityId&&this.addAdminEmail&&this.addAdminEmail.value)e=await window.adminServerApi.addAdmin("communities",this.communityId,this.addAdminEmail.value);else{if(!("domains"===this.modelType&&this.domainId&&this.addAdminEmail&&this.addAdminEmail.value))return void console.warn("Can't find model type or ids");e=await window.adminServerApi.addAdmin("domains",this.domainId,this.addAdminEmail.value)}this._addAdminResponse()}catch(e){this._ajaxError(e)}}async _inviteUser(e){try{let e;if("groups"===this.modelType&&this.groupId&&this.inviteUserEmail&&this.inviteUserEmail.value)e=await window.adminServerApi.inviteUser("groups",this.groupId,this.inviteUserEmail.value,this.inviteType);else{if("communities"!==this.modelType||!this.communityId||!this.inviteUserEmail.value)return void console.warn("Can't find model type or ids");e=await window.adminServerApi.inviteUser("communities",this.communityId,this.inviteUserEmail.value,this.inviteType)}this._inviteUserResponse()}catch(e){this._ajaxError(e)}}_manyItemsResponse(e=!1){this.forceSpinner=!1,this.showReload=!0,e&&window.appGlobals.notifyUserViaToast(this.t("operationInProgressTryReloading")),setTimeout((()=>{this._reload()}),500)}_removeAdminResponse(){window.appGlobals.notifyUserViaToast(this.t("adminRemoved")),this._reload()}_removeManyAdminResponse(){window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("removalsInProgress"),void 0,!0,!1,!0)})),this._manyItemsResponse()}_removeManyUsersResponse(){window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("removalsInProgress"),void 0,!0,!1,!0)})),this._manyItemsResponse()}_removeAndDeleteCompleted(){window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("removalAndDeletionInProgress"),void 0,!0,!1,!0)})),this._removeUserResponse()}_removeAndDeleteManyCompleted(){window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("removalsAndDeletionsInProgress"),void 0,!0,!1,!0)})),this._manyItemsResponse()}_removeUserResponse(){window.appGlobals.notifyUserViaToast(this.t("userRemoved")),this._reload()}_addAdminResponse(){window.appGlobals.notifyUserViaToast(this.t("adminAdded")+" "+this.addAdminEmail.value),this.addAdminEmail.value="",this._reload()}_addOrganizationResponse(e){window.appGlobals.notifyUserViaToast(this.t("organizationUserAdded")+" "+e.detail.response.email),this._reload()}_removeOrganizationResponse(e){window.appGlobals.notifyUserViaToast(this.t("organizationUserRemoved")+" "+e.detail.response.email),this._reload()}_inviteUserResponse(){window.appGlobals.notifyUserViaToast(this.t("users.userInvited")+" "+this.inviteUserEmail.value),this.$$("#inviteUserEmail").value="",this._reload()}_domainIdChanged(){this.domainId&&(this._reset(),this.modelType="domains",this._generateRequest(this.domainId))}_groupIdChanged(){this.groupId&&(this._reset(),this.modelType="groups",this._generateRequest(this.groupId))}_communityIdChanged(){this.communityId&&(this._reset(),this.modelType="communities",this._generateRequest(this.communityId))}_usersResponse(e){this.forceSpinner=!1,this.users=e.detail,this._resetSelectedAndClearCache()}setup(e,t,i,o){this.groupId=void 0,this.communityId=void 0,this.domainId=void 0,this.users=void 0,this.adminUsers=o,e&&(this.groupId=e),t&&(this.communityId=t),i&&(this.domainId=i),this._setupHeaderText()}_reset(){this.users=void 0,this._resetSelectedAndClearCache()}_resetSelectedAndClearCache(){this.selectedUsers=[],this.selectedUsersCount=0,this.selectedUsersEmpty=!0,this.$$("#grid").clearCache()}_setupHeaderText(){this.adminUsers?this.usersCountText=this.t("adminsCount"):this.usersCountText=this.t("usersCount"),this.groupId?this.adminUsers?this.headerText=this.t("group.admins"):this.headerText=this.t("group.users"):this.communityId?this.adminUsers?this.headerText=this.t("community.admins"):this.headerText=this.t("community.users"):this.domainId&&(this.adminUsers?this.headerText=this.t("domainAdmins"):this.headerText=this.t("domainUsers"))}};__decorate$9([e$3("#addAdminEmail")],YpUsersGrid.prototype,"addAdminEmail",void 0),__decorate$9([e$3("#inviteUserEmail")],YpUsersGrid.prototype,"inviteUserEmail",void 0),__decorate$9([n$4({type:String})],YpUsersGrid.prototype,"headerText",void 0),__decorate$9([n$4({type:Array})],YpUsersGrid.prototype,"users",void 0),__decorate$9([n$4({type:Number})],YpUsersGrid.prototype,"groupId",void 0),__decorate$9([n$4({type:Number})],YpUsersGrid.prototype,"communityId",void 0),__decorate$9([n$4({type:Number})],YpUsersGrid.prototype,"domainId",void 0),__decorate$9([n$4({type:Boolean})],YpUsersGrid.prototype,"adminUsers",void 0),__decorate$9([n$4({type:Object})],YpUsersGrid.prototype,"selected",void 0),__decorate$9([n$4({type:String})],YpUsersGrid.prototype,"modelType",void 0),__decorate$9([n$4({type:Array})],YpUsersGrid.prototype,"availableOrganizations",void 0),__decorate$9([n$4({type:Number})],YpUsersGrid.prototype,"userIdForSelectingOrganization",void 0),__decorate$9([n$4({type:Array})],YpUsersGrid.prototype,"selectedUsers",void 0),__decorate$9([n$4({type:Number})],YpUsersGrid.prototype,"selectedUsersCount",void 0),__decorate$9([n$4({type:Boolean})],YpUsersGrid.prototype,"selectedUsersEmpty",void 0),__decorate$9([n$4({type:Array})],YpUsersGrid.prototype,"selectedUserIds",void 0),__decorate$9([n$4({type:Number})],YpUsersGrid.prototype,"selectedUserId",void 0),__decorate$9([n$4({type:String})],YpUsersGrid.prototype,"collectionName",void 0),__decorate$9([n$4({type:String})],YpUsersGrid.prototype,"usersCountText",void 0),__decorate$9([n$4({type:Boolean})],YpUsersGrid.prototype,"showReload",void 0),__decorate$9([n$4({type:Boolean})],YpUsersGrid.prototype,"forceSpinner",void 0),__decorate$9([n$4({type:Number})],YpUsersGrid.prototype,"lastFethedId",void 0),__decorate$9([e$3("#grid")],YpUsersGrid.prototype,"gridElement",void 0),__decorate$9([n$4({type:String})],YpUsersGrid.prototype,"inviteType",void 0),YpUsersGrid=__decorate$9([t$2("yp-users-grid")],YpUsersGrid);var __decorate$8=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpContentModeration=class extends YpBaseElement{constructor(){super(...arguments),this.multiSortEnabled=!1,this.opened=!1,this.showReload=!1,this.forceSpinner=!1,this.selectedItemsEmpty=!0,this.selectedItems=[],this.selectedItemsCount=0,this.typeOfModeration="moderate_all_content",this.allowGridEventsAfterMenuOpen=!1}updated(e){super.updated(e),(e.has("groupId")||e.has("communityId")||e.has("domainId")||e.has("userId")||e.has("typeOfModeration"))&&this._refreshAfterChange(),e.has("activeItem")&&this._activeItemChanged(this.activeItem,e.get("activeItem"))}_onActiveItemChanged(e){this.activeItem=e.detail.value}_selectedItemsChanged(e){e?.detail?.value&&(this.selectedItems=e.detail.value),this.selectedItems&&this.selectedItems.length>0?(this.selectedItemsEmpty=!1,this.selectedItemsCount=this.selectedItems.length):(this.selectedItemsEmpty=!0,this.selectedItemsCount=0),this.selectedItemIdsAndType=(this.selectedItems||[]).map((e=>({id:e.id,modelType:e.type}))),this._refreshGridAsyncDelay()}static get styles(){return[super.styles,i$2`
      ...
      `,e)}renderItemDetail(e,t,i){const o=i.item,n=o.pointTextContent||o.postNameContent||o.postTextContent||o.postTranscriptContent||"";return j(x`
        <div class="details layout vertical detailArea">
          <div class="creatorEmail">${o.user_email||"n/a"}</div>
          <div class="contentText">${n}</div>
          <div class="layout horizontal center-center">
            ${o.is_post?x`
                  <a href="/post/${o.id}" target="_blank">
                    <md-icon-button .ariaLabel="${this.t("linkToContentItem")}">
                      <md-icon>link</md-icon>
                    </md-icon-button>
                  </a>
                `:T$1}
            ${o.is_point&&o.post_id?x`
                  <a href="/post/${o.post_id}/${o.id}" target="_blank">
                    <md-icon-button .ariaLabel="${this.t("linkToContentItem")}">
                      <md-icon>link</md-icon>
                    </md-icon-button>
                  </a>
      ...
      <div class="layout horizontal headerBox wrap">
        ...
        <div class="checkBox" ?hidden="${!this.wide}">
          <md-checkbox ?checked="${this.multiSortEnabled}"
            @change="${e=>{this.multiSortEnabled=e.target.checked}}"
    ...
    `}get spinnerActive(){return!this.totalItemsCount||this.forceSpinner}_ajaxError(e=void 0){this.forceSpinner=!1}async _reload(){this.forceSpinner=!0,await this._refreshAfterChange(),this.forceSpinner=!1}async _masterRequest(e,t=void 0){let i,o;if("groups"===this.modelType&&this.groupId)o=this.groupId;else if("communities"===this.modelType&&this.communityId)o=this.communityId;else if("domains"===this.modelType&&this.domainId)o=this.domainId;else{if("users"!==this.modelType||!this.userId)return void console.error("Can't find model type or ids");o=this.userId}try{if(this.forceSpinner=!0,t&&t.length>0)i=`/api/${this.modelType}/${o}/${e}/process_many_moderation_item`,await window.adminServerApi.adminMethod(i,"DELETE",{items:t}),this._manyItemsResponse();else{if(!this.selectedItemId||!this.selectedModelClass)return console.error("No item ids to process"),void(this.forceSpinner=!1);i=`/api/${this.modelType}/${o}/${this.selectedItemId}/${this.selectedModelClass}/${e}/process_one_moderation_item`,await window.adminServerApi.adminMethod(i,"DELETE"),this._singleItemResponse()}this._resetSelectedAndClearCache()}catch(e){this._ajaxError(e)}}async _generateRequest(e){try{const t=await window.adminServerApi.adminMethod(`/api/${this.modelType}/${e}/${this.typeOfModeration}`,"GET");this.items=t}catch(e){this._ajaxError(e)}}_itemsResponse(e){this.forceSpinner=!1,this.items=e,this._resetSelectedAndClearCache()}get onlyFlaggedItems(){return"flagged_content"===this.typeOfModeration}_manyItemsResponse(){this.forceSpinner=!1,this.showReload=!0,window.appGlobals.notifyUserViaToast(this.t("operationInProgressTryReloading"))}_singleItemResponse(){this._reload()}_menuSelection(){this.renderRoot.querySelectorAll("md-menu").forEach((e=>{e.open=!1})),this._refreshGridAsync()}async _reallyAnonymize(){await this._masterRequest("anonymize")}async _reallyAnonymizeSelected(){await this._masterRequest("anonymize",this.selectedItemIdsAndType)}async _reallyDelete(){await this._masterRequest("delete")}async _reallyDeleteSelected(){await this._masterRequest("delete",this.selectedItemIdsAndType)}async _approve(e){this._setupItemIdFromEvent(e),await this._masterRequest("approve")}async _approveSelected(e){this._setupItemIdFromEvent(e),await this._masterRequest("approve",this.selectedItemIdsAndType)}async _block(e){this._setupItemIdFromEvent(e),await this._masterRequest("block")}async _blockSelected(e){this._setupItemIdFromEvent(e),await this._masterRequest("block",this.selectedItemIdsAndType)}async _clearFlags(e){this._setupItemIdFromEvent(e),await this._masterRequest("clearFlags")}async _clearSelectedFlags(e){this._setupItemIdFromEvent(e),await this._masterRequest("clearFlags",this.selectedItemIdsAndType)}async _refreshAfterChange(){this.domainId&&(this._reset(),this.modelType="domains",await this._generateRequest(this.domainId)),this.groupId&&(this._reset(),this.modelType="groups",await this._generateRequest(this.groupId)),this.communityId&&(this._reset(),this.modelType="communities",await this._generateRequest(this.communityId)),this.userId&&(this._reset(),this.modelType="users",await this._generateRequest(this.userId)),this._setupHeaderText()}_domainIdChanged(){}_groupIdChanged(){}_communityIdChanged(){}_userIdChanged(){}_getType(e){return"post"===e?this.t("posts.posts"):"point"===e?this.t("point.point"):this.t("unknown")}_activeItemChanged(e,t){e&&this.$$("#grid").openItemDetails(e),t&&this.$$("#grid").closeItemDetails(t),this._refreshGridAsync()}_refreshGridAsync(){this._refreshGridAsyncBase(10)}_refreshGridAsyncDelay(){this.allowGridEventsAfterMenuOpen&&this._refreshGridAsyncBase(250)}_refreshGridAsyncBase(e){setTimeout((()=>{this.$$("#grid").notifyResize()}),e)}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this._resizeThrottler.bind(this),!1)}firstUpdated(e){super.firstUpdated(e),this._setGridSize()}_toPercent(e){return e?Math.round(100*e)+"%":null}_resizeThrottler(){this.resizeTimeout||(this.resizeTimeout=setTimeout((()=>{this.resizeTimeout=null,this._setGridSize()}),66))}_setGridSize(){const e=this.$$("#grid");if(!e)return;const t=this.wide?332:0,i=window.innerWidth-t-48;e.style.width=Math.max(i,400).toFixed()+"px",e.style.height=(window.innerHeight-150).toFixed()+"px"}get totalItemsCount(){return this.items?YpFormattingHelpers.number(this.items.length):null}_setupItemIdFromEvent(e){const t=e.currentTarget||e.target;if(null!=t){let e=t.parentElement?.getAttribute("data-args");e||(e=t.getAttribute("data-args")),e&&(this.selectedItemId=parseInt(e));let i=t.parentElement?.getAttribute("data-model-class");i||(i=t.getAttribute("data-model-class")),this.selectedModelClass=i,this._refreshGridAsync()}}_deleteSelected(e){this._setupItemIdFromEvent(e),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureDeleteSelectedContent"),this._reallyDeleteSelected.bind(this),!0,!0)}))}_delete(e){this._setupItemIdFromEvent(e),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureDeleteContent"),this._reallyDelete.bind(this),!0,!1)}))}_anonymizeSelected(e){this._setupItemIdFromEvent(e),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureAnonymizeSelectedContent"),this._reallyAnonymizeSelected.bind(this),!0,!0)}))}_anonymize(e){this._setupItemIdFromEvent(e),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureAnonymizeContent"),this._reallyAnonymize.bind(this),!0,!1)}))}_openSelectedMenu(e){this.$$("#selectedItemsMenu").open=!0}_menuOpened(){this.allowGridEventsAfterMenuOpen=!0}_setSelected(e){const t=e.target.getAttribute("data-args");if(t){const e=this._findItemFromId(parseInt(t));e&&this.$$("#grid").selectItem(e),this.allowGridEventsAfterMenuOpen=!0,setTimeout((()=>{this.$$(`#itemMenu${t}`).open=!0})),this._refreshGridAsync()}}_findItemFromId(e){let t;return this.items?this.items.forEach((i=>{i.id==e&&(t=i)})):console.warn("No item for _findItemFromId"),t}setup(e,t,i,o,n){this.typeOfModeration=o||"flagged_content",this.groupId=void 0,this.communityId=void 0,this.domainId=void 0,this.userId=void 0,this.items=void 0,e&&(this.groupId=e),t&&(this.communityId=t),i&&(this.domainId=i),n&&(this.userId=n),this._setupHeaderText()}open(e){this.collectionName=e}_reset(){this.items=void 0,this._resetSelectedAndClearCache()}_resetSelectedAndClearCache(){this.selectedItemsCount=0,this.selectedItemsEmpty=!0,this.selectedItemIdsAndType=[],this.selectedItems=[],this.$$("#grid").clearCache()}_setupHeaderText(){this.onlyFlaggedItems?this.itemsCountText=this.t("contentItemsFlagged"):this.itemsCountText=this.t("items"),this.groupId?this.headerText=this.t("groupContentModeration"):this.communityId?this.headerText=this.t("communityContentModeration"):this.domainId?this.headerText=this.t("domainContentModeration"):this.userId&&(this.headerText=this.t("userContentModeration"))}};__decorate$8([n$4({type:Boolean})],YpContentModeration.prototype,"multiSortEnabled",void 0),__decorate$8([n$4({type:Boolean})],YpContentModeration.prototype,"opened",void 0),__decorate$8([n$4({type:Boolean})],YpContentModeration.prototype,"showReload",void 0),__decorate$8([n$4({type:Boolean})],YpContentModeration.prototype,"forceSpinner",void 0),__decorate$8([n$4({type:Boolean})],YpContentModeration.prototype,"selectedItemsEmpty",void 0),__decorate$8([n$4({type:Array})],YpContentModeration.prototype,"items",void 0),__decorate$8([n$4({type:Array})],YpContentModeration.prototype,"selectedItems",void 0),__decorate$8([n$4({type:String})],YpContentModeration.prototype,"headerText",void 0),__decorate$8([n$4({type:Number})],YpContentModeration.prototype,"groupId",void 0),__decorate$8([n$4({type:Number})],YpContentModeration.prototype,"communityId",void 0),__decorate$8([n$4({type:Number})],YpContentModeration.prototype,"domainId",void 0),__decorate$8([n$4({type:Number})],YpContentModeration.prototype,"userId",void 0),__decorate$8([n$4({type:Object})],YpContentModeration.prototype,"selected",void 0),__decorate$8([n$4({type:String})],YpContentModeration.prototype,"modelType",void 0),__decorate$8([n$4({type:Number})],YpContentModeration.prototype,"selectedItemsCount",void 0),__decorate$8([n$4({type:Array})],YpContentModeration.prototype,"selectedItemIdsAndType",void 0),__decorate$8([n$4({type:Number})],YpContentModeration.prototype,"selectedItemId",void 0),__decorate$8([n$4({type:String})],YpContentModeration.prototype,"selectedModelClass",void 0),__decorate$8([n$4({type:String})],YpContentModeration.prototype,"collectionName",void 0),__decorate$8([n$4({type:String})],YpContentModeration.prototype,"itemsCountText",void 0),__decorate$8([n$4({type:Object})],YpContentModeration.prototype,"resizeTimeout",void 0),__decorate$8([n$4({type:String})],YpContentModeration.prototype,"typeOfModeration",void 0),__decorate$8([n$4({type:Object})],YpContentModeration.prototype,"activeItem",void 0),YpContentModeration=__decorate$8([t$2("yp-content-moderation")],YpContentModeration);var __decorate$7=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpFraudManagement=class extends YpBaseElement{constructor(){super(...arguments),this.multiSortEnabled=!1,this.showReload=!1,this.selectedItemsEmpty=!0,this.inProgress=!1,this.indeterminateProgress=!1,this.progress=0,this.selectedItemsCount=0,this.selectedMethod="byIpFingerprintPostId",this.selectedCollectionType="endorsements",this.items=[],this.selectedItems=[],this.selectedItemIds=[],this.requestToken=0,this.resizeHandler=this._resizeThrottler.bind(this)}updated(e){super.updated(e),e.has("communityId")&&(this._cancelCurrentRequest(),this._setupHeaderText(),this.communityId&&this._reload()),e.has("activeItem")&&this._activeItemChanged(this.activeItem,e.get("activeItem"))}firstUpdated(e){super.firstUpdated(e),this._setupHeaderText(),this._setGridSize()}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.resizeHandler,!1)}disconnectedCallback(){super.disconnectedCallback(),this._cancelCurrentRequest(),window.removeEventListener("resize",this.resizeHandler,!1)}static get styles(){return[super.styles,i$2`
        :host {
          display: block;
          width: 100%;
        }
      ...
      `]}get totalItemsCount(){return this.items?YpFormattingHelpers.number(this.items.length):null}get availableMethods(){const e=[{value:"byIpFingerprint",label:"IP & FINGERPRINT"},{value:"byMissingBrowserFingerprint",label:"NO FINGERPRINT"},{value:"byIpAddress",label:"IP ADDRESS"}];return"pointQualities"===this.selectedCollectionType?[{value:"byIpFingerprintPointId",label:"IP & FINGERPRINT & POINT"},{value:"byIpUserAgentPointId",label:"IP & USER AGENT & POINT"},...e]:"posts"===this.selectedCollectionType?e:[{value:"byIpFingerprintPostId",label:"IP & FINGERPRINT & POST"},{value:"byIpUserAgentPostId",label:"IP & USER AGENT & POST"},...e]}get activeMethodIndex(){const e=this.availableMethods.findIndex((e=>e.value===this.selectedMethod));return e>-1?e:0}get hidePost(){return!("endorsements"===this.selectedCollectionType||"ratings"===this.selectedCollectionType||"points"===this.selectedCollectionType)}get hidePoint(){return"pointQualities"!==this.selectedCollectionType}get hideValue(){return["posts","points"].includes(this.selectedCollectionType)}get postsCollectionActive(){return"posts"===this.selectedCollectionType}get bulkDeleteAllowed(){return"byMissingBrowserFingerprint"!==this.selectedMethod}_onActiveItemChanged(e){this.activeItem=e.detail.value}_selectedItemsChanged(e){e?.detail?.value&&(this.selectedItems=e.detail.value),this.selectedItems.length>0?(this.selectedItemsEmpty=!1,this.selectedItemsCount=this.selectedItems.length,this.selectedItemIds=this.selectedItems.map((e=>e.id))):(this.selectedItemsEmpty=!0,this.selectedItemsCount=0,this.selectedItemIds=[])}renderKey(e,t,i){const o=i.item;e.innerHTML="";const n=document.createElement("div");n.className="keyCell",n.textContent=`${o.key??""}`,n.style.backgroundColor=`${o.backgroundColor||"transparent"}`,e.appendChild(n)}renderItemDetail(e,t,i){const o=i.item;return j(x`
        <div class="details layout vertical">
          <div class="layout horizontal wrap">
            <div class="layout vertical detailAreas">
              <div><b>Group:</b> ${o.key??""}</div>
              <div><b>Count:</b> ${o.groupCount??""}</div>
              <div><b>IP Address:</b> ${o.ip_address??""}</div>
              <div><b>Browser Id:</b> ${o.data?.browserId??""}</div>
              <div>
                <b>Fingerprint:</b> ${o.data?.browserFingerprint??""}
              </div>
            </div>
            <div class="layout vertical detailAreas">
              <div><b>User Id:</b> ${o.User?.id??""}</div>
              <div><b>Email:</b> ${o.User?.email??""}</div>
              <div ?hidden="${this.hidePost}">
                <b>Post Id:</b> ${o.Post?.id??""}
              </div>
              <div ?hidden="${this.hidePost}">
                <b>Post Name:</b> ${o.Post?.name??""}
              </div>
              <div ?hidden="${this.hidePoint}">
                <b>Point Id:</b> ${o.Point?.id??""}
              </div>
              <div ?hidden="${this.hidePoint}">
                <b>Post Id:</b> ${o.Point?.Post?.id??""}
              </div>
              <div ?hidden="${this.hidePoint}">
                <b>Post Name:</b> ${o.Point?.Post?.name??""}
              </div>
              <div ?hidden="${!this.postsCollectionActive}">
                <b>Post Name:</b> ${o.name??""}
              </div>
              <div><b>Confidence:</b> ${o.confidenceScore??""}</div>
            </div>
          </div>
          <div class="layout vertical detailAreas">
            <div><b>User Agent:</b> ${o.user_agent??""}</div>
          </div>
        </div>
      `,e)}renderSelectedActionHeader(e){return j(x`
        <md-icon-button
          .ariaLabel="${this.t("deleteSelectedContent")}"
          ?disabled="${this.selectedItemsEmpty||this.inProgress||!this.bulkDeleteAllowed}"
      ...
      <div class="toolbar layout horizontal wrap">
        ...
        >
          <option
            value="endorsements"
            ?selected="${"endorsements"===this.selectedCollectionType}"
            >Endorsements</option
          >
          <option
            value="ratings"
            ?selected="${"ratings"===this.selectedCollectionType}"
            >Ratings</option
          >
          <option
            value="pointQualities"
            ?selected="${"pointQualities"===this.selectedCollectionType}"
            >Point qualities</option
          >
          <option
            value="points"
            ?selected="${"points"===this.selectedCollectionType}"
            >Points</option
          >
          <option
            value="posts"
            ?selected="${"posts"===this.selectedCollectionType}"
            >Posts</option
          >
        </select>
        <md-outlined-button
        ...
        >
        ${this.selectedItemsCount>0&&this.bulkDeleteAllowed?x`
              <md-filled-button
                ?disabled="${this.inProgress}"
                @click="${this._deleteSelected.bind(this)}"
      ...
      >
        ${this.availableMethods.map((e=>x`
            <md-secondary-tab ?disabled="${this.inProgress}"
              >${e.label}</md-secondary-tab
            >
          `))}
      </md-tabs>

      ${this.errorMessage?x`<div class="errorText">${this.errorMessage}</div>`:T$1}
      ...
      <vaadin-grid
        ...
        @selected-items-changed="${this._selectedItemsChanged.bind(this)}"
      >
        ${this.bulkDeleteAllowed?x`<vaadin-grid-selection-column></vaadin-grid-selection-column>`:T$1}
        ...
        <vaadin-grid-sort-column
          ...
          .renderer="${(e,t,i)=>{e.textContent=i.item.confidenceScore??""}}"
          header="%"
        ></vaadin-grid-sort-column>
        ...
        <vaadin-grid-sort-column
          ...
          flexGrow="0"
          path="createAtValue"
          .renderer="${(e,t,i)=>{e.textContent=i.item.created_at??""}}"
          .header="${this.t("date")}"
        ></vaadin-grid-sort-column>
        ...
        <vaadin-grid-sort-column
          ...
          flexGrow="0"
          path="data.browserId"
          .renderer="${(e,t,i)=>{e.textContent=i.item.data?.browserId??""}}"
          header="BrowserId"
        ></vaadin-grid-sort-column>
        ...
        <vaadin-grid-sort-column
          ...
          .renderer="${(e,t,i)=>{e.textContent=i.item.data?.browserFingerprint??""}}"
          header="Fingerprint"
        ></vaadin-grid-sort-column>
        ...
        <vaadin-grid-sort-column
          ...
          flexGrow="0"
          path="User.id"
          .renderer="${(e,t,i)=>{e.textContent=i.item.User?.id?.toString()??""}}"
          header="UserId"
        ></vaadin-grid-sort-column>
        ...
        <vaadin-grid-sort-column
          ...
          flexGrow="0"
          path="User.email"
          .renderer="${(e,t,i)=>{e.textContent=i.item.User?.email?.toString()??""}}"
          .header="${this.t("email")}"
        ></vaadin-grid-sort-column>
        ...
        <vaadin-grid-sort-column
          ...
          flexGrow="0"
          path="Post.id"
          .renderer="${(e,t,i)=>{e.textContent=i.item.Post?.id?.toString()??""}}"
          header="PostId"
        ></vaadin-grid-sort-column>
        ...
        <vaadin-grid-sort-column
          ...
          flexGrow="0"
          path="Point.id"
          .renderer="${(e,t,i)=>{e.textContent=i.item.Point?.id?.toString()??""}}"
          header="Point"
        ></vaadin-grid-sort-column>
    ...
    `}_collectionTypeChanged(e){this.selectedCollectionType=e.target.value,this.selectedMethod=this.defaultMethodForCollection(this.selectedCollectionType),this._reload()}_methodTabChanged(e){const t=e.target,i=this.availableMethods[t.activeTabIndex];i&&i.value!==this.selectedMethod&&(this.selectedMethod=i.value,this._reload())}defaultMethodForCollection(e){return"pointQualities"===e?"byIpFingerprintPointId":"posts"===e?"byIpFingerprint":"byIpFingerprintPostId"}async _reload(){this.communityId&&!this.inProgress&&(this._reset(),await this._masterRequest("get-items"))}_cancelCurrentRequest(){this.requestToken+=1,this.pollTimeout&&(window.clearTimeout(this.pollTimeout),this.pollTimeout=void 0),this.jobId=void 0,this.activeRequestToken=void 0,this.activeRequestCommunityId=void 0,this.activeRequestJobId=void 0,this.inProgress=!1,this.indeterminateProgress=!1,this.progress=0,this.currentType=void 0}_isCurrentRequest(e,t,i=this.activeRequestJobId){return void 0!==e&&void 0!==t&&e===this.activeRequestToken&&t===this.activeRequestCommunityId&&i===this.activeRequestJobId}async _masterRequest(e,t=void 0){const i=this.communityId;if(!i)return void console.error("No community id for fraud management");const o=t&&t.length>0?t:this.selectedItemId?[this.selectedItemId]:void 0;if(("delete-one-item"===e||"delete-items"===e)&&!o)return void console.error("No item ids to process");if("delete-items"===e&&!this.bulkDeleteAllowed)return void(this.errorMessage="Bulk delete is disabled for missing fingerprint results");const n=++this.requestToken;this.currentType=e,this.jobId=void 0,this.activeRequestToken=n,this.activeRequestCommunityId=i,this.activeRequestJobId=void 0,this.progress=0,this.errorMessage=void 0,this.inProgress=!0,this.indeterminateProgress="get-items"===e;const a=`/api/communities/${i}/${e}/${this.selectedMethod}/${this.selectedCollectionType}/start_endorsement_fraud_action`;try{const e=await window.adminServerApi.adminMethod(a,"PUT",{idsToDelete:o});if(!this._isCurrentRequest(n,i,void 0))return;this.jobId=e.jobId,this.activeRequestJobId=e.jobId,this.progress=25,this._pollLaterForProgress(n,i,e.jobId)}catch(e){this._isCurrentRequest(n,i,void 0)&&this._ajaxError(e)}}_pollLaterForProgress(e=this.activeRequestToken,t=this.activeRequestCommunityId,i=this.activeRequestJobId){t&&i&&this._isCurrentRequest(e,t,i)&&(this.pollTimeout&&window.clearTimeout(this.pollTimeout),this.pollTimeout=window.setTimeout((async()=>{if(this._isCurrentRequest(e,t,i))try{const o=await window.adminServerApi.adminMethod(`/api/communities/${t}/${i}/endorsement_fraud_action_status`,"GET");this._progressResponse(o,e,t,i)}catch(o){this._isCurrentRequest(e,t,i)&&this._ajaxError(o)}}),1e3))}_progressResponse(e,t=this.activeRequestToken,i=this.activeRequestCommunityId,o=this.activeRequestJobId){if(this._isCurrentRequest(t,i,o)){if(e.error)return this.inProgress=!1,void(this.errorMessage=this.t(e.error)||e.error);this.progress=e.progress??this.progress,this.jobId&&this.progress<100?this._pollLaterForProgress(t,i,o):100===this.progress&&(this.inProgress=!1,this.showReload=!0,"delete-one-item"===this.currentType||"delete-items"===this.currentType?(this._reset(),this._masterRequest("get-items")):(this.items=this._uncompressItems(e.data),this._resetSelectedAndClearCache()))}}_ajaxError(e){console.error(e),this.inProgress=!1,this.errorMessage=this.t("error")||"An error has occured"}_uncompressItems(e){return e?.items?e.items.map((t=>{const i={...t,data:{...t.data},User:t.User?{...t.User}:void 0,Post:t.Post?{...t.Post}:void 0,Point:t.Point?{...t.Point,Post:t.Point.Post?{...t.Point.Post}:void 0}:void 0};return i.backgroundColor=e.cBackgroundColors[Number(i.backgroundColor)]??i.backgroundColor,i.ip_address=e.cIpAddresses[Number(i.ip_address)]??i.ip_address,i.user_agent=e.cUserAgents[Number(i.user_agent)]??i.user_agent,i.User&&(i.User.email=e.cEmails[Number(i.User.email)]??i.User.email,i.User.name=e.cNames[Number(i.User.name)]??e.cEmails[Number(i.User.name)]??i.User.name),"endorsements"!==this.selectedCollectionType&&"ratings"!==this.selectedCollectionType&&"points"!==this.selectedCollectionType||!i.Post||(i.Post.name=e.cPostNames[Number(i.Post.name)]??i.Post.name),"pointQualities"===this.selectedCollectionType&&i.Point?.Post&&(i.Point.Post.name=e.cPostNames[Number(i.Point.Post.name)]??i.Point.Post.name),"posts"===this.selectedCollectionType&&(i.name=e.cPostNames[Number(i.name)]??i.name),i})):[]}_activeItemChanged(e,t){const i=this.$$("#grid");i&&(e&&i.openItemDetails(e),t&&i.closeItemDetails(t),this._refreshGridAsync())}_refreshGridAsync(){window.setTimeout((()=>{this.$$("#grid")?.notifyResize()}),10)}_resizeThrottler(){this.resizeTimeout||(this.resizeTimeout=window.setTimeout((()=>{this.resizeTimeout=void 0,this._setGridSize()}),66))}_setGridSize(){const e=this.$$("#grid");if(!e)return;const t=this.wide?332:0,i=window.innerWidth-t-48;e.style.width=Math.max(i,400).toFixed()+"px",e.style.height=(window.innerHeight-220).toFixed()+"px"}_deleteSelected(){window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureDeleteSelectedContent"),this._reallyDeleteSelected.bind(this),!0,!0)}))}_delete(e){const t=e.currentTarget.getAttribute("data-args");t&&(this.selectedItemId=parseInt(t),window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureDeleteContent"),this._reallyDelete.bind(this),!0,!1)})))}async _reallyDeleteSelected(){this.bulkDeleteAllowed?await this._masterRequest("delete-items",this.selectedItemIds):this.errorMessage="Bulk delete is disabled for missing fingerprint results"}async _reallyDelete(){await this._masterRequest("delete-one-item")}_reset(){this.items=[],this._resetSelectedAndClearCache()}_resetSelectedAndClearCache(){this.selectedItemsCount=0,this.selectedItemsEmpty=!0,this.selectedItemIds=[],this.selectedItems=[],this.activeItem=void 0,this.$$("#grid")?.clearCache()}_setupHeaderText(){this.headerText=this.t("communityFraudManagement"),this.itemsCountText=this.t("items")}};__decorate$7([n$4({type:Boolean})],YpFraudManagement.prototype,"multiSortEnabled",void 0),__decorate$7([n$4({type:Boolean})],YpFraudManagement.prototype,"showReload",void 0),__decorate$7([n$4({type:Boolean})],YpFraudManagement.prototype,"selectedItemsEmpty",void 0),__decorate$7([n$4({type:Boolean})],YpFraudManagement.prototype,"inProgress",void 0),__decorate$7([n$4({type:Boolean})],YpFraudManagement.prototype,"indeterminateProgress",void 0),__decorate$7([n$4({type:Number})],YpFraudManagement.prototype,"communityId",void 0),__decorate$7([n$4({type:Number})],YpFraudManagement.prototype,"jobId",void 0),__decorate$7([n$4({type:Number})],YpFraudManagement.prototype,"progress",void 0),__decorate$7([n$4({type:Number})],YpFraudManagement.prototype,"selectedItemsCount",void 0),__decorate$7([n$4({type:String})],YpFraudManagement.prototype,"selectedMethod",void 0),__decorate$7([n$4({type:String})],YpFraudManagement.prototype,"selectedCollectionType",void 0),__decorate$7([n$4({type:String})],YpFraudManagement.prototype,"collectionName",void 0),__decorate$7([n$4({type:String})],YpFraudManagement.prototype,"headerText",void 0),__decorate$7([n$4({type:String})],YpFraudManagement.prototype,"itemsCountText",void 0),__decorate$7([n$4({type:String})],YpFraudManagement.prototype,"errorMessage",void 0),__decorate$7([n$4({type:Array})],YpFraudManagement.prototype,"items",void 0),__decorate$7([n$4({type:Array})],YpFraudManagement.prototype,"selectedItems",void 0),__decorate$7([n$4({type:Array})],YpFraudManagement.prototype,"selectedItemIds",void 0),__decorate$7([n$4({type:Object})],YpFraudManagement.prototype,"activeItem",void 0),__decorate$7([n$4({type:Object})],YpFraudManagement.prototype,"resizeTimeout",void 0),YpFraudManagement=__decorate$7([t$2("yp-fraud-management")],YpFraudManagement);var __decorate$6=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpAdminModeration=class extends YpAdminPage{constructor(){super(...arguments),this.selectedPage="flagged"}static get styles(){return[super.styles,i$2`
        :host {
          display: block;
          width: 100%;
        }
      ...
      `]}get fraudAvailable(){const e=this.collection;return"community"===this.collectionType&&!!e?.configuration?.enableFraudDetection}get visiblePages(){return this.fraudAvailable?["flagged","all","fraud"]:["flagged","all"]}get activeTabIndex(){const e=this.visiblePages.indexOf(this.selectedPage);return e>-1?e:0}_tabChanged(e){const t=e.target;this.selectedPage=this.visiblePages[t.activeTabIndex]||"flagged"}renderContentModeration(e){switch(this.collectionType){case"domain":return x`
        ...
        `;case"group":return x`
          <yp-content-moderation
            ...
            .typeOfModeration="${e}"
          ></yp-content-moderation>
        `;default:return T$1}}renderSelectedPage(){return"fraud"===this.selectedPage&&this.fraudAvailable?x`
        <yp-fraud-management
          .communityId="${this.collectionId}"
          .collectionName="${this.collection?.name}"
        ></yp-fraud-management>
      `:"all"===this.selectedPage?this.renderContentModeration("moderate_all_content"):this.renderContentModeration("flagged_content")}render(){return x`
      <md-tabs
      ...
      >
        ...
        ${this.fraudAvailable?x`<md-secondary-tab>${this.t("fraudManagement")}</md-secondary-tab>`:T$1}
      </md-tabs>
      ${this.renderSelectedPage()}
    `}};__decorate$6([n$4({type:String})],YpAdminModeration.prototype,"selectedPage",void 0),YpAdminModeration=__decorate$6([t$2("yp-admin-moderation")],YpAdminModeration);var __decorate$5=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpPagesGrid=class extends YpBaseElement{updated(e){super.updated(e),(e.has("groupId")||e.has("communityId")||e.has("domainId"))&&this._updateCollection()}static get styles(){return[super.styles,i$2`
        #dialog {
          width: 90%;
          max-height: 90%;
        }
    ...
    `}_deleteOrganization(e){this.organizationToDeleteId=e.id,window.appDialogs.getDialogAsync("confirmationDialog",(e=>{e.open(this.t("areYouSureYouWantToDeleteThisOrganization"),this._reallyDeleteOrganization.bind(this),!0,!1)}))}async _reallyDeleteOrganization(){try{await window.adminServerApi.adminMethod(`/api/organizations/${this.organizationToDeleteId}`,"DELETE"),this.refresh()}catch(e){console.error(e)}}_afterEdit(){this.shadowRoot.getElementById("editDialog").close(),this.refresh()}_createOrganization(){const e=this.shadowRoot.getElementById("editDialog");e.setup(void 0,!0,this._afterEdit.bind(this)),e.open(!0,{})}_editOrganization(e){const t=this.shadowRoot.getElementById("editDialog");t.organization=e,t.setup(e,!1,this._afterEdit.bind(this)),t.open(!1,{})}_organizationImageUrl(e){return e.OrgLogoImgs?YpMediaHelpers.getImageFormatUrl(e.OrgLogoImgs,2):null}};__decorate$1([n$4({type:Array})],YpOrganizationGrid.prototype,"organizations",void 0),__decorate$1([n$4({type:String})],YpOrganizationGrid.prototype,"headerText",void 0),__decorate$1([n$4({type:String})],YpOrganizationGrid.prototype,"domainId",void 0),__decorate$1([n$4({type:Object})],YpOrganizationGrid.prototype,"selected",void 0),YpOrganizationGrid=__decorate$1([t$2("yp-organization-grid")],YpOrganizationGrid);var __decorate=function(e,t,i,o){for(var n,a=arguments.length,r=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o,s=e.length-1;s>=0;s--)(n=e[s])&&(r=(a<3?n(r):a>3?n(t,i,r):n(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let YpAdminApp=class extends YpBaseElement{static get styles(){return[super.styles,i$2`
      ...
      `]}constructor(){super(),this.page="configuration",this.route="",this.userYpCollection=[],this.adminConfirmed=!1,this.haveCheckedAdminRights=!1,this.anchor=null,this._scrollPositionMap={},this._boundCheckAdminAccess=this._checkAdminAccess.bind(this),this._boundUpdateLocation=this.updateLocation.bind(this),this.updatePageFromPath()}updatePageFromPath(){let e=window.location.pathname;e=e.replace("/admin",""),e.endsWith("/")&&(e=e.substring(0,e.length-1)),e.startsWith("/")&&(e=e.substring(1,e.length));const t=e.split("/");this.collectionType=t[0],"organization"==t[0]&&(this.collectionType="domain"),"new"==t[1]&&t[2]?(this.collectionId="new",window.appGlobals.originalQueryParameters.createCommunityForGroup?this.parentCollectionId=window.appGlobals.domain?.id:this.parentCollectionId=parseInt(t[2]),this.page="configuration"):(this.collectionId=parseInt(t[1]),t.length>3?this.page=t[3]:t.length>2?this.page=t[2]:this.page="configuration")}firstUpdated(e){super.firstUpdated(e)}connectedCallback(){super.connectedCallback(),this._setupEventListeners(),this.updateLocation(),this.hasUpdated&&this._checkAdminAccess()}updateLocation(){let e=window.location.pathname;if(!e.startsWith("/admin/"))return;e=e.replace("/admin","");const t=e.split("/"),i="/:page".split("/"),o={};structuredClone(this.routeData);for(let e=0;e<i.length;e++){const n=i[e];if(!n&&""!==n)break;const a=t.shift();if(!a&&""!==a)return;if(":"==n.charAt(0))o[n.slice(1)]=a;else if(n!==a)return}let n=t.join("/");t.length>0&&(n="/"+n),this.subRoute=n,this.route=e,this.routeData=o,this.updatePageFromPath()}disconnectedCallback(){super.disconnectedCallback(),this._removeEventListeners()}_pageChanged(){this.page&&window.appGlobals.analytics.sendToAnalyticsTrackers("send","pageview",location.pathname)}tabChanged(e){0==e.detail.activeIndex?this.page="configuration":1==e.detail.activeIndex?this.page="moderation":3==e.detail.activeIndex?this.page="users":4==e.detail.activeIndex&&(this.page="admins")}_setupEventListeners(){this.addGlobalListener("yp-logged-in",this._boundCheckAdminAccess),this.addGlobalListener("yp-got-admin-rights",this._boundCheckAdminAccess),this.addGlobalListener("yp-boot-from-server",this._boundCheckAdminAccess),window.addEventListener("location-changed",this._boundUpdateLocation),window.addEventListener("popstate",this._boundUpdateLocation)}_checkAdminAccess(){"new"===this.collectionId?this._setAdminFromParent():!this.collection&&!this._collectionRequest&&window.appUser.user&&Number.isFinite(this.collectionId)&&this.collectionId>0?this.getCollection():this._setAdminConfirmed()}_refreshAdminRights(){window.appUser.recheckAdminRights()}_removeEventListeners(){this.removeGlobalListener("yp-logged-in",this._boundCheckAdminAccess),this.removeGlobalListener("yp-got-admin-rights",this._boundCheckAdminAccess),this.removeGlobalListener("yp-boot-from-server",this._boundCheckAdminAccess),window.removeEventListener("location-changed",this._boundUpdateLocation),window.removeEventListener("popstate",this._boundUpdateLocation)}_refreshGroup(){this._refreshByName("#groupPage")}_refreshCommunity(){this._refreshByName("#communityPage")}_refreshDomain(){this._refreshByName("#domainPage")}_refreshByName(e){this.$$(e)}updated(e){super.updated(e),e.has("page")&&this._pageChanged(),(e.has("collectionType")||e.has("collectionId"))&&(this.adminConfirmed=!1,this.collection=void 0,this.parentCollection=void 0,"new"===this.collectionId?this._setAdminFromParent():(this.parentCollectionId=void 0,Number.isFinite(this.collectionId)&&this.collectionId>0&&this.getCollection())),e.has("collection")}_needsUpdate(){this.requestUpdate()}updateFromCollection(){this.collection&&(this.collection={...this.collection})}renderGroupConfigPage(){return x`<yp-admin-config-group
    ...
    `}_renderPage(){if(!this.adminConfirmed)return T$1;switch(this.page){case"translations":return x`
          ...
          `;case"configuration":switch(this.collectionType){case"domain":return x`
              ...
              `;default:return x``}case"moderation":return x`
            ${this.collection?x`<yp-admin-moderation
                  .collectionType="${this.collectionType}"
                  .collection="${this.collection}"
                  .collectionId="${this.collectionId}"
                ></yp-admin-moderation>`:T$1}
          `;case"pages":switch(this.collectionType){case"domain":return x`
              ...
              `;default:return x``}default:return x``}}async getCollection(){const e=this.collectionType,t=this.collectionId,i={};this._collectionRequest=i;try{const o=await window.serverApi.getCollection(e,t);if(!this.isConnected||!o||this._collectionRequest!==i||e!==this.collectionType||t!==this.collectionId)return;if("group"==this.collectionType){if(this.collection=o.group,!this.collection)return;this.collection.configuration||(this.collection.configuration={}),this.parentCollectionId=this.collection.community_id??this.collection.Community?.id}else this.collection=o,"community"===this.collectionType&&(this.parentCollectionId=this.collection.domain_id??this.collection.Domain?.id);this._setAdminConfirmed()}finally{this._collectionRequest===i&&(this._collectionRequest=void 0)}}async _getAdminCollection(){const e=this.collectionType,t=this.parentCollectionId;if("new"!==this.collectionId||!t||!Number.isFinite(t)||t<0)return;if(!["community","domain","group"].includes(e))return void this.fire("yp-network-error",{message:this.t("unauthorized")});const i="group"!==e||window.appGlobals.originalQueryParameters.createCommunityForGroup?"domain":"community",o=await window.serverApi.getCollection(i,t);this.isConnected&&"new"===this.collectionId&&this.collectionType===e&&this.parentCollectionId===t&&this._setAdminConfirmedFromParent(o)}async _setAdminFromParent(){if("new"!==this.collectionId)return;window.appGlobals.originalQueryParameters.createCommunityForGroup&&(this.parentCollectionId=window.appGlobals.domain?.id);const e=await window.appUser.ensureLoginChecked();this.isConnected&&"new"===this.collectionId&&(e?this.parentCollection&&this.parentCollection.id===this.parentCollectionId?this._setAdminConfirmedFromParent(this.parentCollection):await this._getAdminCollection():window.appUser.openUserlogin())}_setAdminConfirmedFromParent(e){let t=!1;if(e){switch(this.collectionType){case"community":case"domain":t=YpAccessHelpers.checkDomainAccess(e),t||!e.configuration.onlyAdminsCanCreateCommunities&&window.appUser.user&&(t=!0);break;case"group":t=window.appGlobals.originalQueryParameters.createCommunityForGroup?YpAccessHelpers.checkDomainAccess(e):YpAccessHelpers.checkCommunityAccess(e),t||!e.configuration.onlyAdminsCanCreateGroups&&window.appUser.user&&(t=!0)}this.adminConfirmed=t,t||this.fire("yp-network-error",{message:this.t("unauthorized")}),this.parentCollection=e}}_setAdminConfirmed(){if(this.adminConfirmed=!1,this.collection)switch(this.collectionType){case"domain":this.adminConfirmed=YpAccessHelpers.checkDomainAccess(this.collection);break;case"community":this.adminConfirmed=YpAccessHelpers.checkCommunityAccess(this.collection);break;case"group":this.adminConfirmed=YpAccessHelpers.checkGroupAccess(this.collection);break;case"post":this.adminConfirmed=YpAccessHelpers.checkPostAccess(this.collection)}this.collection&&this.haveCheckedAdminRights&&!this.adminConfirmed&&this.fire("yp-network-error",{message:this.t("unauthorized")})}getParentCollectionType(){switch(this.collectionType){case"group":return"community";case"community":case"domain":return"domain";default:return""}}exitToMainApp(){this.active=!1,"new"===this.collectionId?window.appGlobals.originalQueryParameters.createCommunityForGroup?YpNavHelpers.redirectTo(`/domain/${this.parentCollectionId}`):YpNavHelpers.redirectTo(`/${this.getParentCollectionType()}/${this.parentCollectionId}`):YpNavHelpers.redirectTo(`/${this.collectionType}/${this.collectionId}`)}render(){return x`
