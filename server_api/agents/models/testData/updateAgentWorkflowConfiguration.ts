...
async function setupAgentProductsConfiguration() {
    ...
    steps: [
      {
        ...
        shortDescription:
          "A wide search for competitors based on your business description.",
        description:
          "A wide search for competitors based on your business description. The wide search will result in a list of competitors that you and your team can vet as actual competitors.",
      ...
      },
      {
        ...
        description:
          "You and your team can now review the results of the wide search which is a list of potential competitors. Everyone can vote for ten competitors and the competitors with the most votes will move ahead to the next round and become key competitors.",
        agentClassUuid: "a1b2c3d4-e5f6-c7c8-a9c0-c1225354f516",
        ...
        emailInstructions:
          "Use up 👍 and down 👎 thumbs to vet competitors. You can choose as many as you want but <b>only top 10 will go forward</b>, to the next round!",
      },
      {
        name: "Detailed search on key competitors",
        shortName: "Key competitors' details",
        shortDescription:
          "Multi-dimensional search to understand your key competitors.",
        description:
          "Detailed search for competitors in multiple dimensions that include a company overview, recent news & updates, products & services, event participation, customer acquisitions, partnerships and collaborations, and ethical practices.",
      ...
      },
      {
        ...
        shortDescription:
          "Your team can now add their insights about key competitors.",
        description:
          "You and your team can now review the details about competitors and add insights by commenting on competitors. Your comments will used in the final report.",
        agentClassUuid: "c6e99ac4-e5f6-c7c1-a1c0-c1ab53c4ff16",
        type: "engagmentFromOutputConnector",
        ...
        emailInstructions:
          "View the details for key competitors and add your insights before the final report is created.",
      },
      {
        ...
        description:
          "Report on the state of your key competitors where all the information gathered in earlier steps has been consolidated into chapters for each competitor and concludes with a chapter on action-oriented recommendations.",
        ...
        emailInstructions:
          "View the final report on the state of the market based on the competitors analysis.",
      },
    ],
  };
  ...
  if (competitorAgentFreeTrial) {
    competitorAgentFreeTrial.set(
      "configuration.workflow",
      competitionAgentWorkflow
    );
    ...
    const fundingAgentWorkflow: YpWorkflowConfiguration = {
      ...
      steps: [
        ...
        },
        {
          ...
          shortDescription:
            "Select top 20 investors from the wide search results.",
          agentClassUuid: "956e7f74-6fc6-4e01-81b4-098c193e6450",
          type: "engagmentFromOutputConnector",
          stepBackgroundColor: "#e74c3c",
          stepTextColor: "#ffffff",
          ...
          emailInstructions:
            "Use up 👍 and down 👎 thumbs to vet investors. You can choose as many as you want but <b>only top 20 will go forward</b>, to the next round!",
        },
        {
        ...
        },
        {
          ...
          emailInstructions:
            "View the details for key investors and add your insights before the final report is created.",
        },
        {
          ...
          emailInstructions:
            "View the final report on investors and funding opportunities.",
        },
      ],
    };
    ...
    fundingSubscriptionPlan.set("configuration.requiredStructuredQuestions", [
      {
        ...
        type: "textAreaLong",
        description:
          "Detailed description of the business, this is critical for the agent to understand the business and provide accurate results.",
        value: "",
        maxLength: 7500,
        required: true,
        rows: 5,
  ...
  for (let planId = 2; planId <= 5; planId++) {
    ...
    if (subscriptionPlan) {
      subscriptionPlan.set(
        "configuration.type",
        "coming_soon" as YpSubscriptionPlanType
      );
      if (planId == 2) {
        subscriptionPlan.set(
          "configuration.type",
          "paid" as YpSubscriptionPlanType
        );
      }
