...
const getModelAndUsersByType =
  require("./notifications_utils.cjs").getModelAndUsersByType;
const addNotificationsForUsers =
  require("./notifications_utils.cjs").addNotificationsForUsers;
const addOrPossiblyGroupNotification =
  require("./notifications_utils.cjs").addOrPossiblyGroupNotification;
          ...
          getModelAndUsersByType(
            ...
            (error, community) => {
              if (error) {
                ...
                log.warn("Generate Post Notification Not found or muted", {
...
module.exports = (activity, user, callback) => {
  if (activity.type == "activity.post.new") {
    ...
    activity.type == "activity.post.endorsement.new" ||
    activity.type == "activity.post.opposition.new"
  ) {
