...
Polymer({
  _template: `
    ...
    <div class="layout vertical">
      <yp-magic-text id="content" class="story" text-type="pointContent" content-language="[[point.language]]" text-only="" content="[[point.latestContent]]" content-id="[[point.id]]">
      </yp-magic-text>
      ...
      <div class="layout horizontal">
        ...
        <div class="layout horizontal start-justified">
          ...
          <div class="layout horizontal">
            <paper-icon-button class="openCloseButton" icon="keyboard-arrow-right" on-tap="_setOpen" hidden\$="[[open]]"></paper-icon-button>
            <paper-icon-button class="openCloseButton" icon="keyboard-arrow-down" on-tap="_setClosed" hidden\$="[[!open]]"></paper-icon-button>
          </div>
        </div>
      </div>
