...
The `YpLogin` class is a custom web component that extends `YpBaseElement`. It provides a comprehensive login interface with support for various authentication methods, including email/password, Facebook, and SAML. It also supports user registration and anonymous login.
...
| `heading`                     | `string \| undefined`               | The heading text for the login interface.                                   |
...
| `pollingStartedAt`            | `Date \| undefined`                 | The timestamp when polling started.                                         |
...
| `oneTimeLoginName`            | `string \| undefined`               | The name for one-time login.                                                |
...
| `isSending`                   | `boolean`                           | Indicates if a login or registration request is being sent.                 |
...
| `renderLoginSurface`          | -                                                                          | `TemplateResult` | Renders the main login surface.                                             |
...
| `closeAndReset`               | -                                                                          | `void`       | Closes and resets the component state.                                      |
...
| `_setupJsonCredentials`       | `registerMode: boolean`                                                    | `void`       | Sets up the JSON credentials for login or registration.                     |
...
| `render`                      | -                                                                          | `TemplateResult` | Renders the component based on the current mode (dialog or surface).        |
| `_registrationQuestionsChanged` | -                                                                        | `void`       | Handles changes in registration questions.                                  |
...
| `customTermsIntroText`        | -                                                                          | `string`     | Retrieves the custom terms introduction text.                               |
| `userNameText`                | -                                                                          | `string`     | Retrieves the custom user name prompt text.                                 |
...
| `_openTerms`                  | -                                                                          | `void`       | Opens the terms page.                                                       |
| `_facebookLogin`              | -                                                                          | `void`       | Initiates Facebook login.                                                   |
| `oneTimeLogin`                | -                                                                          | `void`       | Initiates one-time login.                                                   |
| `finishOneTimeLoginWithName`  | -                                                                          | `void`       | Completes the one-time login process with a name.                           |
...
| `setupCreateOptions`          | -                                                                          | `void`       | Sets up options for user creation.                                          |
...
| `emailValue`                  | `registerMode: boolean \| undefined`                                       | `string`     | Retrieves the email value based on the mode.                                |
| `passwordValue`               | `registerMode: boolean \| undefined`                                       | `string`     | Retrieves the password value based on the mode.                             |
| `fullnameValue`               | -                                                                          | `string \| void` | Retrieves the full name value.                                              |
...
loginComponent.openDialog('https://redirect.url', 'user@example.com', collectionConfig);
```