...
export class YpFileUpload extends YpBaseElement {
  ...
  _openMediaRecorder() {
    ...
    window.appDialogs.getMediaRecorderAsync(
      (dialog: any /*YpMediaRecorder*/) => {
        dialog.open({
          ...
          if (this.containerType === "posts" && this.group) {
            ...
            options = {
              videoPointUploadLimitSec:
                this.group.configuration.videoPointUploadLimitSec,
              aspect: "",
            };
          } else {
            options = {};
          ...
          if (this.containerType === "posts" && this.group) {
            options = {
              audioPostUploadLimitSec:
                this.group.configuration.audioPostUploadLimitSec,
            };
          } else if (this.containerType === "points" && this.group) {
            options = {
              audioPointUploadLimitSec:
                this.group.configuration.audioPointUploadLimitSec,
            };
          } else {
            options = {};
          }
