import{n as t,t as e,g as i,S as o,i as a,x as s,T as r,h as n,Y as l}from"./CGXYwO41.js";var d=function(t,e,i,o){for(var a,s=arguments.length,r=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o,n=t.length-1;n>=0;n--)(a=t[n])&&(r=(s<3?a(r):s>3?a(e,i,r):a(e,i))||r);return s>3&&r&&Object.defineProperty(e,i,r),r};let h=class extends i{constructor(){super(...arguments),this.new=!1,this.action="/images",this.imageMissing=!1,this._validateForm=()=>{const t=this.$$("#editDialog").getForm(),e=t?.validate()||!1,i=Boolean(this.uploadedPostUserImageId||!this.new&&this.oldUploadedPostUserImageId);return this.imageMissing=!i,e&&i}}static get styles(){return[super.styles,o,a`
        .imagePreview {
          width: min(400px, 100%);
          height: 300px;
          margin: 8px 0 16px;
      ...
      `]}updated(t){super.updated(t),t.has("image")&&this._imageChanged(),t.has("post")&&this._postChanged()}render(){return s`
      <yp-edit-dialog
        doubleWidth
        id="editDialog"
        icon="photo_camera"
        ...
        ${this.image?s`
              <div class="layout vertical center-center">
                ...
                ${this.imagePreviewUrl?s`
                      <yp-image
                        class="imagePreview"
                        sizing="contain"
                        .alt="${this.image.description||this.t("post.newPhoto")}"
                        .title="${this.image.description||this.t("post.newPhoto")}"
    ...
    `}async open(t,e,i,o){this.url=t,this.label=e,this.haveSharedContentCallback=o,this.image=i,this.requestUpdate(),await this.updateComplete,this.$$("#shareButton").share()}};k([t({type:Object})],$.prototype,"haveSharedContentCallback",void 0),k([t({type:String})],$.prototype,"url",void 0),k([t({type:String})],$.prototype,"image",void 0),k([t({type:String})],$.prototype,"label",void 0),$=k([e("yp-share-dialog")],$);
