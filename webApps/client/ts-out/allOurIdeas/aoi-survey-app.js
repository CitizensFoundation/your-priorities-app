...
let AoiSurveyApp = class AoiSurveyApp extends YpBaseElement {
    constructor() {
        super();
        this.pageIndex = 1;
        ...
        window.aoiAppGlobals = new AoiaoiAppGlobals(window.aoiServerApi);
        ...
        this.earlName = window.aoiAppGlobals.earlName;
    ...
    async getEarl() {
        ...
        window.aoiAppGlobals.exernalGoalParamsWhiteList =
    ...
    externalGoalTrigger() {
        try {
            ...
            let whiteList = window.aoiAppGlobals.exernalGoalParamsWhiteList;
            if (whiteList) {
                whiteList = whiteList
                    .toLowerCase()
                    .split(',')
...
], AoiSurveyApp.prototype, "pageIndex", void 0);
__decorate([
    property({ type: Number })
], AoiSurveyApp.prototype, "totalNumberOfVotes", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "lastSnackbarText", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "collectionType", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "earlName", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "currentError", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "themePrimaryColor", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "themeSecondaryColor", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "themeTertiaryColor", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "themeNeutralColor", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "themeScheme", void 0);
__decorate([
    property({ type: Boolean })
], AoiSurveyApp.prototype, "themeHighContrast", void 0);
__decorate([
    property({ type: Object })
], AoiSurveyApp.prototype, "earl", void 0);
__decorate([
    property({ type: Object })
], AoiSurveyApp.prototype, "question", void 0);
__decorate([
    property({ type: Object })
], AoiSurveyApp.prototype, "prompt", void 0);
__decorate([
    property({ type: Boolean })
], AoiSurveyApp.prototype, "isAdmin", void 0);
__decorate([
    property({ type: Boolean })
], AoiSurveyApp.prototype, "surveyClosed", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "appearanceLookup", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "currentLeftAnswer", void 0);
__decorate([
    property({ type: String })
], AoiSurveyApp.prototype, "currentRightAnswer", void 0);
__decorate([
    property({ type: Number })
], AoiSurveyApp.prototype, "currentPromptId", void 0);
AoiSurveyApp = __decorate([
    customElement('aoi-survey-app')
], AoiSurveyApp);
export { AoiSurveyApp };
//# sourceMappingURL=aoi-survey-app.js.map