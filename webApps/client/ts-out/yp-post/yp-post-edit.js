...
export const EditPostTabs = {
    Description: 0,
    Point: 1,
    Location: 2,
    Media: 3,
};
let YpPostEdit = class YpPostEdit extends YpEditBase {
    constructor() {
        super(...arguments);
        this.action = "/posts";
        this.newPost = false;
        this.saveSurveyAnswers = true;
        this.disableDialog = false;
        this.skipIfSavedSurveyAnswers = true;
        this.locationHidden = false;
        this.selected = 0;
        this.mapActive = false;
        this.hasOnlyOneTab = false;
    ...
    async _getTranslationsIfNeeded() {
        ...
        if (this.autoTranslate &&
            ...
            const translatedTexts = await window.serverApi.getSurveyQuestionsTranslations(this.group, this.language);
    ...
    _setSelectedTab(event) {
        this.selected = event.target.activeTabIndex;
    }
    ...
    renderCoverMediaContent() {
      ...
      `;
        ...
        else if (this.post?.PostHeaderImages &&
        ...
        <div style="position: relative;">
          <yp-image
            class="image"
            sizing="cover"
            src="${YpMediaHelpers.getImageFormatUrl(this.post?.PostHeaderImages)}"
          ></yp-image>
        </div>
      `;
        }
    ...
    _setSelectedCoverMediaType(event) {
        this.selectedCoverMediaType = event.target.value;
    }
    ...
    _alternativeTextForNewIdeaSaveButtonTranslation() {
        setTimeout(() => {
            const label = this.$$("#alternativeTextForNewIdeaSaveButtonId");
    ...
    _updatePostTitle() {
        setTimeout(() => {
            const label = this.$$("#customTitleQuestionTextId");
            if (label && label.finalContent) {
    ...
    connectedCallback() {
        ...
        this.addGlobalListener("yp-language-loaded", this.setupTranslation.bind(this));
    ...
    disconnectedCallback() {
        ...
        this.removeGlobalListener("yp-language-loaded", this.setupTranslation.bind(this));
    ...
    get replacedName() {
        ...
        if (post && group && group.configuration.hideNameInputAndReplaceWith) {
            ...
            text = text.replace("<DATESECONDS>", DateTime.now().toFormat("DD/MM/YYYY hh:mm:ss"));
            text = text.replace("<DATEMINUTES>", DateTime.now().toFormat("DD/MM/YYYY hh:mm"));
    ...
    _submitWithStructuredQuestionsString() {
        ...
        for (let i = 0; i < this.structuredQuestions.length; i += 1) {
            ...
            if (this.structuredQuestions[i].text &&
                this.structuredQuestions[i].text[this.structuredQuestions[i].text.length - 1] !== "?")
                description += ":";
            description += "\n";
    ...
    customSubmit() {
        ...
        else if (this.structuredQuestions &&
    ...
    _videoUploaded(event) {
        ...
        this.$$("#mediaVideo").checked = true;
        setTimeout(() => {
            this.fire("iron-resize");
        }, 50);
    }
    _audioUploaded(event) {
    ...
    async _redirectAfterVideo(post) {
        this.post = post;
    ...
    async _redirectAfterAudio(post) {
        this.post = post;
    ...
    get surveyAnswerLocalstorageKey() {
        return `yp-survey-response-v2-for-${this.group.id}-${window.appUser.user.id}`;
    }
    saveSurveyAnswersToLocalStorage() {
        localStorage.setItem(this.surveyAnswerLocalstorageKey, JSON.stringify(this.structuredAnswersJson));
    }
    async checkSurveyAnswers() {
        setTimeout(() => {
            ...
            if (answersText) {
                ...
                this.$$("#editDialog")._reallySubmit(false);
            }
        }, 10);
    }
    customRedirect(post) {
        if (post) {
            if (post.newEndorsement &&
                window.appUser &&
    ...
    _finishRedirect(post) {
        ...
        const customThankYouTextNewPostsId = this.$$("#customThankYouTextNewPostsId");
        if (this.group &&
            this.group.configuration &&
    ...
    async setup(post, newItem, refreshFunction, group, params = undefined) {
            ...
            if (group.configuration) {
                ...
                if (group.configuration.structuredQuestionsJson) {
                    setTimeout(() => {
                        ...
                        this.uniqueIdsToElementIndexes = {};
                        this.liveUniqueIds = [];
                        group.configuration.structuredQuestionsJson.forEach((question, index) => {
    ...
    _alternativeTextForNewIdeaButtonHeaderTranslation() {
        setTimeout(() => {
            const label = this.$$("#alternativeTextForNewIdeaButtonHeaderId");
            if (label && label.finalContent) {
...
], YpPostEdit.prototype, "action", void 0);
__decorate([
    property({ type: Boolean })
], YpPostEdit.prototype, "newPost", void 0);
__decorate([
    property({ type: Number })
], YpPostEdit.prototype, "selectedCategoryArrayId", void 0);
__decorate([
    property({ type: Array })
], YpPostEdit.prototype, "initialStructuredAnswersJson", void 0);
__decorate([
    property({ type: Array })
], YpPostEdit.prototype, "structuredQuestions", void 0);
__decorate([
    property({ type: Object })
], YpPostEdit.prototype, "post", void 0);
__decorate([
    property({ type: Object })
], YpPostEdit.prototype, "group", void 0);
__decorate([
    property({ type: Boolean })
], YpPostEdit.prototype, "saveSurveyAnswers", void 0);
__decorate([
    property({ type: Boolean })
], YpPostEdit.prototype, "disableDialog", void 0);
__decorate([
    property({ type: Boolean })
], YpPostEdit.prototype, "skipIfSavedSurveyAnswers", void 0);
__decorate([
    property({ type: Boolean })
], YpPostEdit.prototype, "locationHidden", void 0);
__decorate([
    property({ type: Object })
], YpPostEdit.prototype, "location", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "encodedLocation", void 0);
__decorate([
    property({ type: Number })
], YpPostEdit.prototype, "selectedCategoryId", void 0);
__decorate([
    property({ type: Number })
], YpPostEdit.prototype, "uploadedVideoId", void 0);
__decorate([
    property({ type: Number })
], YpPostEdit.prototype, "uploadedAudioId", void 0);
__decorate([
    property({ type: Object })
], YpPostEdit.prototype, "response", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "errorText", void 0);
__decorate([
    property({ type: Number })
], YpPostEdit.prototype, "currentVideoId", void 0);
__decorate([
    property({ type: Number })
], YpPostEdit.prototype, "currentAudioId", void 0);
__decorate([
    property({ type: Number })
], YpPostEdit.prototype, "selected", void 0);
__decorate([
    property({ type: Boolean })
], YpPostEdit.prototype, "mapActive", void 0);
__decorate([
    property({ type: Boolean })
], YpPostEdit.prototype, "hasOnlyOneTab", void 0);
__decorate([
    property({ type: Number })
], YpPostEdit.prototype, "postDescriptionLimit", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "sructuredAnswersString", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "structuredAnswersJson", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "structuredAnswersString", void 0);
__decorate([
    property({ type: Array })
], YpPostEdit.prototype, "translatedQuestions", void 0);
__decorate([
    property({ type: Boolean })
], YpPostEdit.prototype, "autoTranslate", void 0);
__decorate([
    property({ type: Boolean })
], YpPostEdit.prototype, "submitDisabled", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "uploadedDocumentUrl", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "uploadedVideoUrl", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "uploadedDocumentFilename", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "selectedCoverMediaType", void 0);
__decorate([
    property({ type: Number })
], YpPostEdit.prototype, "uploadedHeaderImageId", void 0);
__decorate([
    property({ type: String })
], YpPostEdit.prototype, "customTitleQuestionText", void 0);
__decorate([
    query("#form")
], YpPostEdit.prototype, "formElement", void 0);
YpPostEdit = __decorate([
    customElement("yp-post-edit")
], YpPostEdit);
export { YpPostEdit };
//# sourceMappingURL=yp-post-edit.js.map