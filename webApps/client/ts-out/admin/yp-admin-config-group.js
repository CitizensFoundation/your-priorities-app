...
let YpAdminConfigGroup = YpAdminConfigGroup_1 = class YpAdminConfigGroup extends YpAdminConfigBase {
            ...
            items: [
                {
                    text: "canAddNewPosts",
                    type: "checkbox",
                    value: this.group.configuration.canAddNewPosts === undefined
                        ? true
    ...
    _openDelete() {
        ...
        window.appDialogs.getDialogAsync("apiActionDialog", (dialog) => {
            dialog.setup("/api/groups/" + this.group.id, this.t("groupDeleteConfirmation"), this._onDeleted.bind(this));
    ...
    _updateEarl(event, earlUpdatePath, parseJson = false) {
        ...
        return {
            ...
            items: [
                ...
                },
                {
                    ...
                    value: earl?.configuration?.accept_new_ideas !== undefined
                ...
                },
                {
                    text: "hide_analysis",
                    type: "checkbox",
                    onChange: (e) => this._updateEarl(e, "configuration.hide_analysis"),
                ...
                },
                {
                    text: "hide_skip",
                    type: "checkbox",
                    onChange: (e) => this._updateEarl(e, "configuration.hide_skip"),
                ...
                },
                {
                    text: "hide_explain",
                    type: "checkbox",
                    onChange: (e) => this._updateEarl(e, "configuration.hide_explain"),
