...
let YpAiChatElement = class YpAiChatElement extends YpBaseElement {
    constructor() {
        super();
...
], YpAiChatElement.prototype, "message", void 0);
__decorate([
    property({ type: String })
], YpAiChatElement.prototype, "updateMessage", void 0);
__decorate([
    property({ type: String })
], YpAiChatElement.prototype, "sender", void 0);
__decorate([
    property({ type: String })
], YpAiChatElement.prototype, "detectedLanguage", void 0);
__decorate([
    property({ type: Number })
], YpAiChatElement.prototype, "clusterId", void 0);
__decorate([
    property({ type: String })
], YpAiChatElement.prototype, "type", void 0);
__decorate([
    property({ type: Boolean })
], YpAiChatElement.prototype, "spinnerActive", void 0);
__decorate([
    property({ type: Boolean })
], YpAiChatElement.prototype, "fullReferencesOpen", void 0);
__decorate([
    property({ type: String })
], YpAiChatElement.prototype, "followUpQuestionsRaw", void 0);
__decorate([
    property({ type: Array })
], YpAiChatElement.prototype, "followUpQuestions", void 0);
__decorate([
    property({ type: Boolean })
], YpAiChatElement.prototype, "jsonLoading", void 0);
YpAiChatElement = __decorate([
    customElement('yp-ai-chat-element')
], YpAiChatElement);
export { YpAiChatElement };
//# sourceMappingURL=yp-chatbot-element.js.map