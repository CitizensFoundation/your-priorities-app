...
let YpAgentWorkflowWidget = class YpAgentWorkflowWidget extends YpBaseElement {
    ...
    renderExplanation() {
      ...
      <div class="explanation-icon">${this.renderIcon("users")}</div>
      <div class="explanation-text">${this.t("peopleStep")}</div>

      <div class="explanation-icon">${this.renderIcon("sparkles")}</div>
      <div class="explanation-text">${this.t("aiStep")}</div>
