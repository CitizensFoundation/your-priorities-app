export class YpOfficialStatusHelper {
    static officialStatusOptions(t) {
        return [
    ...
    static officialStatusOptionsName(official_status, t) {
    ...
    static officialStatusOptionsNamePlural(official_status, t) {
        const statues = YpOfficialStatusHelper.officialStatusOptions(t);
        let foundName = "Not found";
...
//# sourceMappingURL=YpOfficialStatusHelper.js.map