...
let PlausibleGoalGraph = class PlausibleGoalGraph extends PlausibleBaseGraph {
    static get styles() {
        return [
            ...super.styles,
            css `
    ...
    regenerateChart() {
        ...
        const dataSet = this.buildDataSet(this.graphData.plot, this.graphData.present_index, this.ctx);
            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: {
                        ...
                        intersect: false,
                        position: 'average',
                        external: this.graphTooltip(this.graphData, graphEl, this.$$('#chartjs-tooltip')),
                    },
                },
                responsive: true,
...
__decorate([
    property({ type: Array })
], PlausibleGoalGraph.prototype, "events", void 0);
PlausibleGoalGraph = __decorate([
    customElement('pl-goal-graph')
], PlausibleGoalGraph);
export { PlausibleGoalGraph };
//# sourceMappingURL=pl-goal-graph.js.map