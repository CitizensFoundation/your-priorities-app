...
let PlausibleSourcesAll = class PlausibleSourcesAll extends PlausibleSourcesBase {
    constructor() {
        super(...arguments);
        this.to = undefined;
    }
    ...
    fetchReferrers() {
        ...
        api
            .get(this.proxyUrl, `/api/stats/${encodeURIComponent(this.site.domain)}/sources`, this.query, { show_noref: this.showNoRef })
            .then((res) => {
            this.loading = false;
            this.referrers = res;
        });
...
], PlausibleSourcesAll.prototype, "to", void 0);
PlausibleSourcesAll = __decorate([
    customElement('pl-sources-all')
], PlausibleSourcesAll);
export { PlausibleSourcesAll };
//# sourceMappingURL=pl-sources-all.js.map