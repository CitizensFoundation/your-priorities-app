...
let YpDataVisualization = class YpDataVisualization extends YpBaseElement {
    static get styles() {
        return [
            super.styles,
            css `
    ...
    _drawCharts() {
        ...
        this._drawChart('#overallTarget', data.overallTargetPercent, this.t('overall'), data.overallColor ? data.overallColor : '#5bac51');
        this._drawChart('#overallActual', data.overallActualPercent, this.t('actual'), data.overallColor ? data.overallColor : '#5bac51');
        this._drawChart('#yearTarget', data.yearTargetPercent, this.t('overall'), data.yearColor ? data.yearColor : '#004f77');
        this._drawChart('#yearActual', data.yearActualPercent, this.t('actual'), data.yearColor ? data.yearColor : '#004f77');
    }
    _drawChart(chartId, percentDone, labelText, color, hideGray = false) {
        // @ts-ignore
...
], YpDataVisualization.prototype, "group", void 0);
YpDataVisualization = __decorate([
    customElement('yp-data-visualization')
], YpDataVisualization);
export { YpDataVisualization };
//# sourceMappingURL=yp-data-visualization.js.map